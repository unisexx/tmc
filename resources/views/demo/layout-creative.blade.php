@extends('layouts.layout-cre')

@section('title', 'Layout Creative')
@section('breadcrumb-item', 'Layout')

@section('breadcrumb-item-active', 'Layout Creative')
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row g-3 mt-3">
                        ...
                        <div class="col-auto">
                            <a href="#" class="avtar avtar-s bg-brand-color-2"
                                onclick="changebrand('bg-brand-color-2')">
                                <i class="ph-duotone ph-paint-brush text-white f-18"></i>
                            </a>
                        </div>
                        <div class="col-auto">
                            <a href="#" class="avtar avtar-s bg-brand-color-3"
                                onclick="changebrand('bg-brand-color-3')">
                                <i class="ph-duotone ph-paint-brush text-white f-18"></i>
                            </a>
                        </div>
                        <div class="col-auto">
