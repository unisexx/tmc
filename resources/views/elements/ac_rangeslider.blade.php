...
@section('breadcrumb-title', 'Range Slider')
@section('breadcrumb-text', 'Create an input element in the DOM, and then create an instance of Slider')

@section('breadcrumb-link', 'https://seiyria.com/bootstrap-slider')

@section('css')
    <!-- [Page specific CSS] start -->
    <link href="{{ URL::asset('build/css/plugins/bootstrap-slider.min.css') }}" rel="stylesheet" type="text/css">
        ...
        <div class="col-lg-4 col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr />
                    <input id="ex22" type="text" data-slider-id="slider22" data-slider-min="0"
                        data-slider-max="20" data-slider-step="1" data-slider-value="14"
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="well" dir="rtl">
                        <span>-5</span>
                        <input id="ex24" type="text" data-slider-min="-5" data-slider-max="20"
                            data-slider-step="1" data-slider-value="14" />
                        <span>20</span>
                    </div>
                </div>
...
@section('scripts')
    ...
    <!-- range slider Js -->
    <script src="{{ URL::asset('build/js/plugins/bootstrap-slider.min.js') }}"></script>
    <script src="{{ URL::asset('build/js/elements/ac-rangeslider.js') }}"></script>
