...
@section('title', 'Material Icons Set')
@section('breadcrumb-item', 'Icons')

@section('breadcrumb-item-active', 'Material Icons')
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5>Material Icon</h5>
                    <p>Use material two tone icon with
                        <code>&lt;i class="material-icons-two-tone"&gt; &lt;&lt; Copied code &gt;&gt;&lt;/i&gt;</code> in you
                        html code
                    </p>
                </div>
