...
@section('breadcrumb-title', 'Button')
@section('breadcrumb-text', 'Use Bootstrap’s custom button styles for actions in forms, dialogs, and more with support
    for multiple sizes, states, and more.')

@section('breadcrumb-link', 'https://getbootstrap.com/docs/5.2/components/buttons/')
            ...
            <div class="card">
                ...
                <div class="card-body pc-component">
                    <div class="d-flex flex-wrap gap-2">
                        ...
                        <a class="btn btn-primary disabled" tabindex="-1" role="button" href="#">Disabled Primary
                            link</a>
    ...
    <div class="row btn-page">
                ...
                <div class="card-body pc-component">
                    <div class="d-flex flex-wrap gap-2">
                        <button type="button" class="btn btn-primary d-inline-flex"><i
                                class="ti ti-thumb-up me-1"></i>Primary</button>
                        <button type="button" class="btn btn-secondary d-inline-flex"><i
                                class="ti ti-camera me-1"></i>Secondary</button>
                        <button type="button" class="btn btn-success d-inline-flex"><i
                                class="ti ti-circle-check me-1"></i>Success</button>
                        <button type="button" class="btn btn-danger d-inline-flex"><i
                                class="ti ti-alert-triangle me-1"></i>Danger</button>
                        <button type="button" class="btn btn-warning d-inline-flex"><i
                                class="ti ti-triangle me-1"></i>Warning</button>
                        <button type="button" class="btn btn-info d-inline-flex"><i
        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body pc-component">
                    <div class="d-flex flex-wrap gap-2">
                        <button type="button" class="btn btn-outline-primary d-inline-flex"><i
                                class="ti ti-thumb-up me-1"></i>Primary</button>
                        <button type="button" class="btn btn-outline-secondary d-inline-flex"><i
                                class="ti ti-camera me-1"></i>Secondary</button>
                        <button type="button" class="btn btn-outline-success d-inline-flex"><i
                                class="ti ti-circle-check me-1"></i>Success</button>
                        <button type="button" class="btn btn-outline-danger d-inline-flex"><i
                                class="ti ti-alert-triangle me-1"></i>Danger</button>
                        <button type="button" class="btn btn-outline-warning d-inline-flex"><i
                                class="ti ti-triangle me-1"></i>Warning</button>
                        <button type="button" class="btn btn-outline-info d-inline-flex"><i
                                class="ti ti-info-circle me-1"></i>Info</button>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body pc-component">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="d-flex flex-wrap gap-2 mb-4">
                                ...
                                <button type="button" class="btn btn-icon btn-danger"><i
                                        class="ti ti-alert-triangle"></i></button>
                                <button type="button" class="btn btn-icon btn-warning"><i
                                        class="ti ti-triangle"></i></button>
                        ...
                        <div class="col-lg-6">
                            <h5>Light</h5>
                            <div class="d-flex flex-wrap gap-2 mb-4">
                                <button type="button" class="btn btn-icon btn-light-primary"><i
                                        class="ti ti-thumb-up"></i></button>
                                <button type="button" class="btn btn-icon btn-light-secondary"><i
                                        class="ti ti-camera"></i></button>
                                <button type="button" class="btn btn-icon btn-light-success"><i
                                        class="ti ti-circle-check"></i></button>
                                <button type="button" class="btn btn-icon btn-light-danger"><i
                                        class="ti ti-alert-triangle"></i></button>
                                <button type="button" class="btn btn-icon btn-light-warning"><i
                                        class="ti ti-triangle"></i></button>
                                <button type="button" class="btn btn-icon btn-light-info"><i
                                        class="ti ti-info-circle"></i></button>
                            </div>
                        </div>
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            <h5>Link</h5>
                            <div class="d-flex flex-wrap gap-2 mb-4">
                                <button type="button" class="btn btn-icon btn-link-primary"><i
                                        class="ti ti-thumb-up"></i></button>
                                <button type="button" class="btn btn-icon btn-link-secondary"><i
                                        class="ti ti-camera"></i></button>
                                <button type="button" class="btn btn-icon btn-link-success"><i
                                        class="ti ti-circle-check"></i></button>
                                <button type="button" class="btn btn-icon btn-link-danger"><i
                                        class="ti ti-alert-triangle"></i></button>
                                <button type="button" class="btn btn-icon btn-link-warning"><i
                                        class="ti ti-triangle"></i></button>
                                <button type="button" class="btn btn-icon btn-link-info"><i
                                        class="ti ti-info-circle"></i></button>
                            </div>
                        </div>
                        <div class="col-lg-6">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p>use <code>.btn-group-lg</code> in class <code>.btn-group</code> class to get Large size button group
                    </p>
                </div>
                <div class="card-body pc-component">
                    <div class="row">
                            ...
                            <div class="btn-group-vertical" role="group"
                                ...
                                <div class="btn-group" role="group">
                                    <button id="btnGroupDrop3" type="button"
                                        class="btn m-0 btn-secondary dropdown-toggle" data-bs-toggle="dropdown"
