...
@section('breadcrumb-title', 'Syntax Highlighter')
@section('breadcrumb-text', 'Prism is a lightweight, extensible syntax highlighter, built with modern web standards in
    mind. It’s used in millions of websites, including some of those you visit daily.')

@section('breadcrumb-link', 'https://prismjs.com/')
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p>The recommended way to mark up a code block (both for semantics and for Prism) is a
                        ...
                        with a element <code>&lt;code&gt;</code> inside, like so:</p>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p>Obviously, this is supposed to work only for code blocks (<code>&lt;pre&gt;&lt;code&gt;</code>) and
                        not for inline
                        code. Add class line-numbers to your desired <code>&lt;pre&gt;</code> and line-numbers plugin will
                        take care.</p>
                    <p>Optional: You can specify the data-start (Number) attribute on the <code>&lt;pre&gt;</code> element.
                        It will shift
                        the line counter.</p>
                    <h6 class="m-t-20 f-w-600">Usage:</h6>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p>You specify the lines to be highlighted through the data-line attribute on the
                        <code>&lt;pre&gt;</code> element, in
                        the following simple format:</p>
                    <ol>
