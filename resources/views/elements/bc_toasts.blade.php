...
@section('breadcrumb-text', 'Push notifications to your visitors with a toast, a lightweight and easily customizable
    alert message.')
                        ...
                        <div class="toast fade show" role="alert" aria-live="assertive" aria-atomic="true">
                            <div class="toast-body">
                                ...
                                <div class="mt-2 pt-2 border-top">
                                    <button type="button" class="btn btn-light-primary btn-sm mb-1 me-1">Take
                                        action</button>
    ...
    <script>
        ...
        a &&
            document.getElementById('selectToastPlacement').addEventListener('change', function() {
                a.dataset.originalClass || (a.dataset.originalClass = a.className), (a.className = a.dataset
                    .originalClass + ' ' + this.value);
            });
