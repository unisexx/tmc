...
@section('breadcrumb-title', 'Typography')
@section('breadcrumb-text', 'Documentation and examples for Bootstrap typography, including global settings, headings,
    body text, lists, and more.')

@section('breadcrumb-link', 'https://getbootstrap.com/docs/5.2/content/typography/')
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5>Headings</h5>
                    <p><span class="badges">.h1</span> through .h6 classes are also available, for when you want to match the
                        font styling
