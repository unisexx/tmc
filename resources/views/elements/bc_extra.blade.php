...
@section('breadcrumb-title', 'Utilities')
@section('breadcrumb-text', 'The utility API is a Sass-based tool to generate utility classes.')

@section('breadcrumb-link', 'https://getbootstrap.com/docs/5.2/utilities/background/')
        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="bg-white px-3 py-2 d-inline-block rounded">
                        <a href="#" class="me-0 link-dark">Dark link</a>
                    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-10 col-sm-12">
                            <p class="lh-1">Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Donec
                                sed odio dui. Cras mattis pannenkoek
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-10 col-sm-12">
                            <p class="lh-sm">Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Donec
                                sed odio dui. Cras mattis pannenkoek
                                purus sit amet fermentum.</p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-10 col-sm-12">
                            <p class="lh-lg">Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Donec
                                sed odio dui. Cras mattis pannenkoek
                                purus sit amet fermentum.</p>
                        </div>
                    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-10 col-sm-12">
                            <p><a href="#" class="pe-auto">This link</a> can be clicked (this is default behaviour).
                            </p>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-10 col-sm-12">
                            <p class="pe-none"><a href="#">This link</a> can not be clicked because the
                                ...
                                <code>pe-auto</code> class and can be
                                clicked.
                            </p>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="p-4 my-3">
                        <div class="position-relative bg-body" style="height: 250px">
                            ...
                            <div class="hei-40 wid-40 rounded bg-secondary position-absolute top-50 start-100 translate-middle"
                                data-bs-toggle="tooltip" title="position-absolute top-50 start-100 translate-middle">
                            </div>
                            ...
                            <div class="hei-40 wid-40 rounded bg-secondary position-absolute top-100 start-50 translate-middle"
                                data-bs-toggle="tooltip" title="position-absolute top-100 start-50 translate-middle">
                            </div>
                            <div class="hei-40 wid-40 rounded bg-secondary position-absolute top-100 start-100 translate-middle"
                                data-bs-toggle="tooltip" title="position-absolute top-100 start-100 translate-middle">
                            </div>
                        </div>
                    </div>
                    <hr />
                    ...
                    <div class="p-3 p-sm-5 d-flex justify-content-between">
                    ...
                    <p class="mb-0">You can use these classes with existing components to create new ones. Remember that
                        ...
                        by adding entries to the <code>$position-values</code> variable.</p>
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            <label data-bs-toggle="tooltip" class="badge bg-light-secondary p-1"
                                title="margin-0">.m-0</label>
                            <label data-bs-toggle="tooltip" class="badge bg-light-secondary p-1"
                                title="margin-5">.m-5</label>
                            <label data-bs-toggle="tooltip" class="badge bg-light-secondary p-1"
        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body pc-component">
                    <div class="shadow-none p-3 mb-3 bg-body rounded">No shadow</div>
                    <div class="shadow-sm p-3 mb-3 rounded">Small shadow</div>
                    <div class="shadow p-3 mb-3 rounded">Regular shadow</div>
                    <div class="shadow-lg p-3 mb-3 rounded">Larger shadow</div>
                </div>
            </div>
        </div>
        <!-- [ shadows ] end -->
                        ...
                        <div class="col-md-8">
                            <div class="ratio ratio-16x9">
                                <iframe class="embed-responsive-item"
                                    src="https://www.youtube.com/embed/1jWCXJfxHQM?rel=0" allowfullscreen></iframe>
                            </div>
                        </div>
                    </div>
                </div>
