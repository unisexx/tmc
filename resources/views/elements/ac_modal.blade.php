...
@section('breadcrumb-text', 'Use Bootstrap’s JavaScript modal plugin to add dialogs to your site for lightboxes or
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body btn-page">
                    ...
                    <button data-pc-animate="3d-flip-vertical" type="button" class="btn btn-primary" data-bs-toggle="modal"
                        data-bs-target="#animateModal">
                        3D Flip (vertical)
                    </button>
                </div>
        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body btn-page">
                    <button data-pc-animate="3d-rotate-bottom" type="button" class="btn btn-primary" data-bs-toggle="modal"
                        data-bs-target="#animateModal">
                        3D Rotate Bottom
                    </button>
                    <button data-pc-animate="3d-rotate-InLeft" type="button" class="btn btn-primary" data-bs-toggle="modal"
                        data-bs-target="#animateModal">
                        3D Rotate InLeft
                    </button>
                </div>
