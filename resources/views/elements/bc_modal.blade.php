...
@section('title', 'Modal')
@section('breadcrumb-title', 'Modal')
@section('breadcrumb-text', 'Use Bootstrap’s JavaScript modal plugin to add dialogs to your site for lightboxes, user
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <p>This
                                        <a href="#!" role="button" class="btn btn-secondary tooltip-test"
                                            data-bs-toggle="tooltip" title="Button Tooltip"
                ...
                <div class="card-body pc-component">
                    <div class="modal fade" id="exampleModalToggle" aria-labelledby="exampleModalToggleLabel"
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalToggleLabel"><span
                                            class="badge bg-danger">1</span> First Modal </h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                    ...
                    <div class="modal fade" id="exampleModalToggle2" aria-labelledby="exampleModalToggleLabel2"
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalToggleLabel2"><span
                                            class="badge bg-success">2</span> Second Modal</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
