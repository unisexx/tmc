...
@section('title', 'เข้าสู่ระบบ | ระบบประเมินผลการจัดบริการหน่วยบริการสุขภาพผู้เดินทาง')
        ...
        <div class="card my-5">
            <div class="card-body">
                <div class="text-center">
                    {{-- ชื่อระบบ --}}
                    <h3 class="mb-4">ระบบประเมินผลการจัดบริการหน่วยบริการสุขภาพผู้เดินทาง</h3>

                    <img src="{{ URL::asset('build/images/authentication/img-auth-login.png') }}" alt="images" class="img-fluid mb-3">

                    <h4 class="f-w-500 mb-1">เข้าสู่ระบบด้วยอีเมลของคุณ</h4>
                    <p class="mb-3">
                        ยังไม่มีบัญชีผู้ใช้งาน?
                        <a href="{{ route('register') }}" class="link-primary ms-1">สร้างบัญชีใหม่</a>
                    </p>
                </div>
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="d-flex mt-1 justify-content-between align-items-center">
                        ...
                        <a href="{{ route('password.request') }}">
                            <h6 class="f-w-400 mb-0">ลืมรหัสผ่าน?</h6>
                        </a>
                    </div>
                ...
                {{-- ถ้าอยากใช้ social login ให้เปิดคอมเมนต์นี้ --}}
                {{--
