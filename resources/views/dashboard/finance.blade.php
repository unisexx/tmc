...
@section('breadcrumb-item-active', 'Finance')
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="card rounded-4 overflow-hidden"
                        style="background-image: url(../build/images/widget/img-card-bg.svg); background-size: cover">
                        <div class="card-body">
                            <div class="d-flex">
                                ...
                                <div class="flex-shrink-0">
                                    <img src="{{ URL::asset('build/images/widget/img-card-master.svg') }}" alt="img"
                                        class="img-fluid" />
                                </div>
                            </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6 col-xxl-3">
                            <div class="card shadow-none border mb-0">
                                <div class="card-body p-3">
                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                        <img src="{{ URL::asset('build/images/widget/img-food.png') }}" alt="img"
                                            class="img-fluid" />
                                        <div class="dropdown">
                        ...
                        <div class="col-md-6 col-xxl-3">
                            <div class="card shadow-none border mb-0">
                                <div class="card-body p-3">
                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                        <img src="{{ URL::asset('build/images/widget/img-travel.png') }}" alt="img"
                                            class="img-fluid" />
                                        <div class="dropdown">
                                            <a class="avtar avtar-xs btn-link-secondary dropdown-toggle arrow-none"
                                                href="#" data-bs-toggle="dropdown" aria-haspopup="true"
                        ...
                        <div class="col-md-6 col-xxl-3">
                            <div class="card shadow-none border mb-0">
                                <div class="card-body p-3">
                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                        <img src="{{ URL::asset('build/images/widget/img-shoping.png') }}" alt="img"
                                            class="img-fluid" />
                                        <div class="dropdown">
                                            <a class="avtar avtar-xs btn-link-secondary dropdown-toggle arrow-none"
                                                href="#" data-bs-toggle="dropdown" aria-haspopup="true"
                        ...
                        <div class="col-md-6 col-xxl-3">
                            <div class="card shadow-none border mb-0">
                                <div class="card-body p-3">
                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                        <img src="{{ URL::asset('build/images/widget/img-helth.png') }}" alt="img"
                                            class="img-fluid" />
                                        <div class="dropdown">
                                            <a class="avtar avtar-xs btn-link-secondary dropdown-toggle arrow-none"
                                                href="#" data-bs-toggle="dropdown" aria-haspopup="true"
                        ...
                        <div class="col-12">
                            <div class="card shadow-none border mb-0">
                                <div class="card-body p-3">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="{{ URL::asset('build/images/widget/img-card-1.png') }}" alt="img"
                                                class="img-fluid" />
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <div
                        ...
                        <div class="col-12">
                            <div class="card shadow-none border mb-0">
                                <div class="card-body p-3">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="{{ URL::asset('build/images/widget/img-card-2.png') }}" alt="img"
                                                class="img-fluid" />
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <div
                                ...
                                <span class="card shadow-none border mb-0">
                                    <span class="card-body p-3 text-center">
                                        <span class="d-flex align-items-center justify-content-center gap-2 flex-column">
                                            <span class="avtar avtar-s bg-dark text-white rounded-circle">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center justify-content-between gap-2 my-3">
                        <a href="#" class="avtar border border-secondary rounded-circle btn-light-secondary">
                            <i class="ti ti-plus f-20"></i>
                        </a>
                        <a href="#" class="avtar"><img class="rounded-circle img-fluid"
                                src="{{ URL::asset('build/images/user/avatar-1.jpg') }}" alt="User image" /></a>
                        <a href="#" class="avtar"><img class="rounded-circle img-fluid"
                                src="{{ URL::asset('build/images/user/avatar-2.jpg') }}" alt="User image" /></a>
                        <a href="#" class="avtar"><img class="rounded-circle img-fluid"
                                src="{{ URL::asset('build/images/user/avatar-3.jpg') }}" alt="User image" /></a>
                        <a href="#" class="avtar"><img class="rounded-circle img-fluid"
                                src="{{ URL::asset('build/images/user/avatar-4.jpg') }}" alt="User image" /></a>
                    </div>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item px-0">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="{{ URL::asset('build/images/user/avatar-1.jpg') }}" alt="img"
                                        class="wid-30 rounded-circle" />
                                </div>
                                <div class="flex-grow-1 ms-3">
                                    <div class="row g-1">
                                        <div class="col-6">
                        ...
                        <li class="list-group-item px-0">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="{{ URL::asset('build/images/user/avatar-2.jpg') }}" alt="img"
                                        class="wid-30 rounded-circle" />
                                </div>
                                <div class="flex-grow-1 ms-3">
                                    <div class="row g-1">
                        ...
                        <li class="list-group-item px-0">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="{{ URL::asset('build/images/widget/img-acitivity-3.svg') }}" alt="img"
                                        class="wid-30 rounded-circle" />
                                </div>
                                <div class="flex-grow-1 ms-3">
                                    <div class="row g-1">
...
@section('scripts')
    ...
    <script src="{{ URL::asset('build/js/widgets/finance.js') }}"></script>
@endsection
