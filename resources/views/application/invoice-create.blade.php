                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td><input type="text" class="form-control"
                                                                    placeholder="Name" value="Mauris" /></td>
                                                            <td><input type="text" class="form-control"
                                                                    placeholder="Description"
                                                                    value="Malesuada adipiscing" /></td>
                                                            <td><input type="number" class="form-control" placeholder="Qty"
                                                                    value="2" /></td>
                                                            <td><input type="text" class="form-control"
                                                                    placeholder="Total Amount" value="$80.00" /></td>
                                                        ...
                                                        <tr>
                                                            <td>2</td>
                                                            <td><input type="text" class="form-control"
                                                                    placeholder="Name" value="Vitae" /></td>
                                                            <td><input type="text" class="form-control"
                                                                    placeholder="Description" value="Hac egestas" /></td>
                                                            <td><input type="number" class="form-control"
                                                                    placeholder="Qty" value="3" /></td>
                                                            <td><input type="text" class="form-control"
                                                                    placeholder="Total Amount" value="$40.00" /></td>
                                                            <td class="text-center"><a href="#"
                                                                    class="avtar avtar-s btn-link-danger btn-pc-default"><i
                                                                        class="ti ti-trash f-20"></i></a></td>
                                                        </tr>
                                            ...
                                            <div class="text-start">
                                                <button class="btn btn-sm btn-light-primary"><i class="ti ti-plus"></i>
                                                    Add new item</button>
                                                <hr class="mb-0" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row align-items-center justify-content-between g-3">
                                                ...
                                                <div class="col-sm-auto btn-page">
                                                    <a href="/application/invoice-view"
                            ...
                            <div class="address-check border rounded p-3">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label d-block" for="address-check-1">
                                        ...
                                        <span class="text-muted address-details">1754 Ureate Path, 695 Newga View,
                                            Seporcus, Rhode Island, Belgium - SA5 5BO</span>
                                        <span class="row align-items-center justify-content-between">
                                            ...
                                            <span class="col-6 text-end">
                                                <span
                                                    ...
                                                    <span class="btn btn-sm btn-outline-primary">Deliver to this
                                                        address</span>
                                                </span>
                                            </span>
                                        </span>
                    ...
                    <div class="collapse multi-collapse">
                        <div class="row">
                            <div class="col-12">
                                <div class="mb-3 row align-items-center">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="form-check form-check-inline">
                                            ...
                                            <label class="form-check-label" for="addtypecheck1"> Home (All day Delivery)
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="flexRadioDefault"
                                                id="addtypecheck2" />
                                            <label class="form-check-label" for="addtypecheck2"> Work (Between 10 AM to 5
                                                PM) </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label class="col-lg-4 col-form-label">First Name :<small
                                            class="text-muted d-block">Enter your first name</small></label>
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" />
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label class="col-lg-4 col-form-label">Last Name :<small
                                ...
                                <div class="mb-3 row">
                                    <label class="col-lg-4 col-form-label">Email Id :<small
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="" id="checkaddres"
                                            checked />
                                        <label class="form-check-label" for="checkaddres"> Save this new address for
                                ...
                                <div class="text-end btn-page mb-0 mt-4">
                                    ...
                                    <button class="btn btn-primary" data-bs-dismiss="modal">Save & Deliver to this
                                        Address</button>
                                </div>
                            </div>
                        </div>
