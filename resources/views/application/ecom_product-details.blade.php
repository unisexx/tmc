                ...
                <div class="card-body">
                    <div class="row">
                                ...
                                <div id="carouselExampleCaptions" class="carousel slide ecomm-prod-slider"
                                    ...
                                    <div class="carousel-inner bg-light rounded position-relative">
                                        ...
                                        <div class="carousel-item active">
                                            <img src="{{ URL::asset('build/images/application/img-prod-1.jpg') }}" class="d-block w-100"
                                                alt="Product images" />
                                        </div>
                                        <div class="carousel-item">
                                            <img src="{{ URL::asset('build/images/application/img-prod-2.jpg') }}" class="d-block w-100"
                                                alt="Product images" />
                                        </div>
                                        <div class="carousel-item">
                                            <img src="{{ URL::asset('build/images/application/img-prod-3.jpg') }}" class="d-block w-100"
                                                alt="Product images" />
                                        </div>
                                        <div class="carousel-item">
                                            <img src="{{ URL::asset('build/images/application/img-prod-4.jpg') }}" class="d-block w-100"
                                                alt="Product images" />
                                        </div>
                                        <div class="carousel-item">
                                            <img src="{{ URL::asset('build/images/application/img-prod-5.jpg') }}" class="d-block w-100"
                                                alt="Product images" />
                                        </div>
                                        <div class="carousel-item">
                                            <img src="{{ URL::asset('build/images/application/img-prod-6.jpg') }}" class="d-block w-100"
                                                alt="Product images" />
                                        </div>
                                        <div class="carousel-item">
                                            <img src="{{ URL::asset('build/images/application/img-prod-7.jpg') }}" class="d-block w-100"
                                                alt="Product images" />
                                        </div>
                                        <div class="carousel-item">
                                            <img src="{{ URL::asset('build/images/application/img-prod-8.jpg') }}" class="d-block w-100"
                                                alt="Product images" />
                                        </div>
                                    </div>
                                    <ol
                                        ...
                                        <li data-bs-target="#carouselExampleCaptions" data-bs-slide-to="0"
                                            ...
                                            <img src="{{ URL::asset('build/images/application/img-prod-1.jpg') }}"
                                        ...
                                        <li data-bs-target="#carouselExampleCaptions" data-bs-slide-to="4"
                                            class="list-inline-item w-25 h-auto">
                                            <img src="{{ URL::asset('build/images/application/img-prod-5.jpg') }}"
                                                class="d-block wid-50 rounded" alt="Product images" />
                                        </li>
                                        <li data-bs-target="#carouselExampleCaptions" data-bs-slide-to="5"
                                            class="list-inline-item w-25 h-auto">
                                            <img src="{{ URL::asset('build/images/application/img-prod-6.jpg') }}"
                                                class="d-block wid-50 rounded" alt="Product images" />
                                        </li>
                                        <li data-bs-target="#carouselExampleCaptions" data-bs-slide-to="6"
                                            class="list-inline-item w-25 h-auto">
                                            <img src="{{ URL::asset('build/images/application/img-prod-7.jpg') }}"
                                                class="d-block wid-50 rounded" alt="Product images" />
                                        </li>
                                        <li data-bs-target="#carouselExampleCaptions" data-bs-slide-to="7"
                                            class="list-inline-item w-25 h-auto">
                                            <img src="{{ URL::asset('build/images/application/img-prod-8.jpg') }}"
                                                class="d-block wid-50 rounded" alt="Product images" />
                                        </li>
                                    </ol>
                                </div>
                        ...
                        <div class="col-md-6">
                                ...
                                <div class="offer-check border rounded p-3">
                                    <div class="form-check">
                                        <input type="radio" name="radio1" class="form-check-input input-primary"
                                            id="customCheckdef1" checked="" />
                                        <label class="form-check-label d-block" for="customCheckdef1">
                                            <span class="h6 mb-0 d-block">No Cost EMI</span>
                                            <span class="text-muted offer-details">Upto ₹2,322.51 EMI interest savings on
                                                select Credit CardsUpto ₹2,322.51 EMI interest savings on select
                                                Credit Cards</span>
                                            <span class="h6 mb-0 text-primary">1 Offer <i
                                ...
                                <div class="offer-check border rounded p-3">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label d-block" for="customCheckdef2">
                                            ...
                                            <span class="text-muted offer-details">Upto ₹1,250.00 discount on select Credit
                                                CardsUpto ₹2,322.51 EMI interest savings on select Credit
                                                Cards</span>
                                            <span class="h6 mb-0 text-primary">1 Offer <i
                                                    class="ti ti-arrow-narrow-right"></i></span>
                                        </label>
                            ...
                            <div class="mb-3 row">
                                <label class="col-form-label col-lg-3 col-sm-12">Colors <span
                            ...
                            <div class="mb-3 row align-items-center">
                                ...
                                <div class="col-lg-9 col-md-12 col-sm-12">
                                    <div class="row g-2">
                                        ...
                                        <div class="col-auto">
                                            <input type="radio" class="btn-check" id="btnrdolite2"
                                                name="btn_radio2" />
                                            <label class="btn btn-sm btn-light-primary" for="btnrdolite2">Medium</label>
                                        </div>
                                        <div class="col-auto">
                                            <input type="radio" class="btn-check" id="btnrdolite3"
                                                name="btn_radio2" />
                            ...
                            <div class="mb-3 row">
                                <label class="col-form-label col-lg-3 col-sm-12">Quantity <span
                                        class="text-danger">*</span></label>
                            ...
                            <h3 class="mb-4"><b>$299.00</b><span
                                    class="mx-2 f-16 text-muted f-w-400 text-decoration-line-through">$399.00</span></h3>
                            <div class="row">
                                <div class="col-6">
                                    <div class="d-grid">
                            ...
                            <div class="table-responsive">
                                <p class="text-muted">Lorem Ipsum is simply dummy text of the printing and typesetting
                                    ...
                                    <strong class="text-body">“When an unknown printer took a galley of type and scrambled
                                        it to make a type specimen book.”</strong>
                                    It has survived not only five centuries, but also the leap into electronic typesetting,
                                    remaining essentially
                                    unchanged. It was popularized in the 1960s with the release of Lestrade sheets
                                    containing Lorem Ipsum passages, and
                                    more recently with desktop publishing software like PageMaker including versions of
                                    Lorem Ipsum.
                                </p>
                                <p class="text-muted mb-0">It was popularized in the 1960s with the release of Learjet
                                    sheets containing Lorem Ipsum passages, and more
                                    recently with desktop publishing software like PageMaker including versions of Lorem
                                    Ipsum.</p>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-start">
                                        <div class="flex-shrink-0">
                                            <div class="chat-avtar">
                                                <img class="img-radius img-fluid wid-40"
                                                    src="{{ URL::asset('build/images/user/avatar-2.jpg') }}" alt="User image" />
                                                <div class="bg-success chat-badge"></div>
                                            </div>
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                    ...
                    <div class="row gy-3">
                            ...
                            <div class="card product-card mb-0">
                                <div class="card-img-top">
                                    <a href="/application/ecom_product-details">
                                        <img src="{{ URL::asset('build/images/application/img-prod-2.jpg') }}" alt="image"
                        ...
                        <div class="col-sm-6 col-xxl-3 col-xl-4">
                            <div class="card product-card mb-0">
                                <div class="card-img-top">
                                    <a href="/application/ecom_product-details">
                                        <img src="{{ URL::asset('build/images/application/img-prod-3.jpg') }}" alt="image"
                                            class="img-prod img-fluid" />
                                    </a>
                                    <div class="card-body position-absolute end-0 top-0">
                                        <div class="form-check prod-likes">
                        ...
                        <div class="col-sm-6 col-xxl-3 col-xl-4">
                            <div class="card product-card mb-0">
                                <div class="card-img-top">
                                    <a href="/application/ecom_product-details">
                                        <img src="{{ URL::asset('build/images/application/img-prod-4.jpg') }}" alt="image"
                                            class="img-prod img-fluid" />
                                    </a>
                                    <div class="card-body position-absolute end-0 top-0">
                                        <div class="form-check prod-likes">
                        ...
                        <div class="col-sm-6 col-xxl-3 col-xl-4">
                            <div class="card product-card mb-0">
                                <div class="card-img-top">
                                    <a href="/application/ecom_product-details">
                                        <img src="{{ URL::asset('build/images/application/img-prod-5.jpg') }}" alt="image"
                                            class="img-prod img-fluid" />
                                    </a>
                                    <div class="card-body position-absolute end-0 top-0">
                                        <div class="form-check prod-likes">
