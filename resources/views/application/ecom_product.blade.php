                                                            ...
                                                            <div class="col-6">
                                                                ...
                                                                <div class="form-check my-2">
                                                                    <input class="form-check-input" type="radio"
                                                                        ...
                                                                        value="option2" />
                                                                    <label class="form-check-label" for="pricefilter2">$50
                                                                        - $100</label>
                                                                </div>
                                                                <div class="form-check my-2">
                                                                    <input class="form-check-input" type="radio"
                                                            ...
                                                            <div class="col-6">
                                                                <div class="form-check my-2">
                                                                    <input class="form-check-input" type="radio"
                                                                        ...
                                                                        value="option1" />
                                                                    <label class="form-check-label" for="pricefilter4">$10
                                                                        - $50</label>
                                                                </div>
                                                                <div class="form-check my-2">
                                                                    <input class="form-check-input" type="radio"
                    ...
                    <div class="row">
                            ...
                            <div class="card product-card">
                                <div class="card-img-top">
                                    <a href="/application/ecom_product-details">
                                        <img src="{{ URL::asset('build/images/application/img-prod-1.jpg') }}" alt="image"
                        ...
                        <div class="col-sm-6 col-xl-4">
                            <div class="card product-card">
                                <div class="card-img-top">
                                    <a href="/application/ecom_product-details">
                                        <img src="{{ URL::asset('build/images/application/img-prod-6.jpg') }}" alt="image"
                                            class="img-prod img-fluid" />
                                    </a>
                                    <div class="card-body position-absolute end-0 top-0">
                                        <div class="form-check prod-likes">
                        ...
                        <div class="col-sm-6 col-xl-4">
                            <div class="card product-card">
                                <div class="card-img-top">
                                    <a href="/application/ecom_product-details">
                                        <img src="{{ URL::asset('build/images/application/img-prod-7.jpg') }}" alt="image"
                                            class="img-prod img-fluid" />
                                    </a>
                                    <div class="card-body position-absolute end-0 top-0">
                                        <div class="form-check prod-likes">
                        ...
                        <div class="col-sm-6 col-xl-4">
                            <div class="card product-card">
                                <div class="card-img-top">
                                    <a href="/application/ecom_product-details">
                                        <img src="{{ URL::asset('build/images/application/img-prod-8.jpg') }}" alt="image"
                                            class="img-prod img-fluid" />
                                    </a>
                                    <div class="card-body position-absolute end-0 top-0">
                                        <div class="form-check prod-likes">
                        ...
                        <div class="col-sm-6 col-xl-4">
                            <div class="card product-card">
                                <div class="card-img-top">
                                    <a href="/application/ecom_product-details">
                                        <img src="{{ URL::asset('build/images/application/img-prod-9.jpg') }}" alt="image"
                                            class="img-prod img-fluid" />
                                    </a>
                                    <div class="card-body position-absolute end-0 top-0">
                                        <div class="form-check prod-likes">
