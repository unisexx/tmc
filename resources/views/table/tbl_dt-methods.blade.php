...
@section('title', 'Table Methods')
@section('breadcrumb-item', 'Table')

@section('breadcrumb-item-active', 'Table Methods')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div id="hide">
                                ...
                                <div class="mb-3" id="columns"></div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <h5>Import / Export Data</h5>
                            <div class="mb-3">
                                <textarea cols="30" rows="2" class="form-control" placeholder="Paste your csv or json string here..."></textarea>
                            </div>
                            <div class="mb-3 btn-page">
