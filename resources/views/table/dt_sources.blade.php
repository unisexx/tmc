        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <small>The foundation for DataTables is progressive enhancement, so it is very adept at reading table
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <small>At times you will wish to be able to create a table from dynamic information passed directly to
                        DataTables, rather than
