...
@section('breadcrumb-item-active', 'RowReorder')
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <small>Note that sorting is enabled on all columns in this example - you may wish to restrict sorting to
                        just the sequence
                        column to help prevent potential user confusion if they reorder when the table ordering is performed
                        on a different
                        column.</small>
                </div>
                <div class="card-body">
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <small>By default only the first cell in the row will trigger the reordering action. This example shows
                        the entire row being
                        able to start the reorder. Simply click and drag anywhere on the row</small>
                </div>
                <div class="card-body">
                    <div class="dt-responsive table-responsive">
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <small>This example shows RowReorder being used with the Responsive extension for DataTables and also
                        that it provides support
                        for touch inputs to perform a row reorder. Responsive is particularly useful with mobile devices,
                        but can also be useful
                        on desktops where complex data sets are shown in the DataTable.</small>
                </div>
                <div class="card-body">
                    <div class="dt-responsive table-responsive">
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <small>Providing the UI to allow end users to reorder a table is only half of the story - likely you
                        will wish to have the
                        changes caused by the end user to effect a database or some other data store.</small>
                </div>
                <div class="card-body">
                    <div class="dt-responsive table-responsive">
...
@section('scripts')
    ...
    <script src="{{ URL::asset('build/js/plugins/dataTables.rowReorder.min.js') }}"></script>
    <script>
        // [ Basic Row Reorder ]
