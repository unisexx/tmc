    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          ...
          <small
            >If you are looking to emulate the UI of spreadsheet programs such as Excel with DataTables, the combination of KeyTable
            and AutoFill will take you a long way there!</small
          >
        </div>
        <div class="card-body">
          <div class="dt-responsive table-responsive">
            <table id="key-integration" class="table table-striped table-bordered nowrap">
              <thead>
                <tr>
                  <th>Name</th>
                  <th>Position</th>
    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          ...
          <small
            >This ability to exclude columns from the AutoFill action can be particularly useful if the table contains non-data
            columns. This example uses the Select extension for DataTables to allow row selection through the select option</small
          >
        </div>
        <div class="card-body">
          <div class="dt-responsive table-responsive">
    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          ...
          <small
            >When dragging an AutoFill handle, the table (if DataTables scrolling is enabled) or the window will be automatically
            scrolled</small
          >
        </div>
        <div class="card-body">
