...
@section('title', 'Add Rows Bootstrap Table')
@section('breadcrumb-item', 'DataTable')

@section('breadcrumb-item-active', 'Add Row')
        ...
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body table-border-style">
                    <button class="btn btn-light-primary mb-3" id="add">Add 1000 Rows</button>
                    <div class="table-responsive">
                        <table class="table" id="pc-dt-addrow">
                            <thead>
                                <tr>
                                    <th>Name</th>
                                    <th>Ext.</th>
...
@section('scripts')
    ...
    <script>
        var datatable = new simpleDatatables.DataTable('#pc-dt-addrow', {
