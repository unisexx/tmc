...
@section('breadcrumb-item-active', 'FixedColumns')
    ...
    <div class="col-xxl-6 col-md-12">
      <div class="card">
        <div class="card-header">
          ...
          <small
            >FixedColumns has the ability to freeze columns on both the left and the right hand sides of the table. By default it will
            fix the first column on the left, but using the initialization parameters</small
          >
        </div>
        <div class="card-body">
...
@section('scripts')
    ...
    <script src="{{ URL::asset('build/js/plugins/dataTables.fixedColumns.min.js') }}"></script>
    <script>
      // [ left-right-fix
