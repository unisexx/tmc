    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5>DOM/Jquery</h5>
                    <small>Events assigned to the table can be exceptionally useful for user interaction, however you must
                        be aware that DataTables
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <small>This example shows the person's age combined with their name in the first column, hiding the age
                        column.</small>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <small>In addition to this, you can also use dom to create multiple instances of these table controls.
                        Simply include the
                        feature's identification letter where you want it to appear.</small>
                </div>
                <div class="card-body">
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <small>Complex headers (using colspan / rowspan) can be used to group columns of similar information in
                        DataTables, creating a
                        very powerful visual effect.</small>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5>Language File</h5>
                    <small>As well as being able to pass language information to DataTables through the language
                        initialization option, you can also
                        store the language information in a file</small>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <small>When working with DataTables over multiple pages it is often useful to set the initialization
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5>Row Grouping</h5>
                    <small>Although DataTables doesn't have row grouping built-in (picking one of the many methods available
                        would overly limit the
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <small>Through the use of the header and footer callback manipulation functions provided by DataTables
                        (headerCallback and
                        footerCallback), it is possible to perform some powerful and useful data manipulation
                        functions.</small>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <small>DataTables inserts DOM elements around the table to control DataTables features, and you can make
                        use of this mechanism
                        as well to insert your own custom elements</small>
                </div>
                <div class="card-body">
                    <div class="table-responsive dt-responsive">
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <small>The following example shows how a callback function can be used to format a particular row at
                        draw time.</small>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
