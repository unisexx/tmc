...
@section('breadcrumb-item-active', 'Export Button')
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header table-card-header">
                    ...
                    <small>This example demonstrates these four button types with their default options. The other examples
                        in this section
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <small>All of the data export buttons have an exportOptions option which can be used to specify
                        information about what data
                        should be exported and how.</small>
                </div>
                <div class="card-body">
                    <div class="dt-responsive table-responsive">
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <small>The Excel export button saves to an XLSX file and the data can be customised before exporting the
                        file using the
                        customize method</small>
                </div>
                <div class="card-body">
                    <div class="dt-responsive table-responsive">
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <small>This example makes use of buttons.exportData() to get data from the host DataTable and then
