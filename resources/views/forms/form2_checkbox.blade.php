...
@section('breadcrumb-item-active', 'Checkbox')
                ...
                <div class="card-body">
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="checkbox" value="" id="flexCheckCheckedDisabled"
                                    checked disabled />
                                <label class="form-check-label" for="flexCheckCheckedDisabled"> Disabled checked checkbox
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-0">
                        ...
                        <div class="col-sm-9">
                            ...
                            <small
                                class="form-text text-muted"><code>document.querySelector('your-checkbox').indeterminate=!0;</code></small>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                <div class="mb-0">
                                    ...
                                    <div class="form-check mb-2">
                                        <input class="form-check-input input-secondary" type="checkbox" id="customCheckc2"
                                            checked />
                                    ...
                                    <div class="form-check mb-2">
                                        <input class="form-check-input input-danger" type="checkbox" id="customCheckc4"
                                            checked />
                                        <label class="form-check-label" for="customCheckc4">danger</label>
                                    </div>
                                    <div class="form-check mb-2">
                                        <input class="form-check-input input-warning" type="checkbox" id="customCheckc5"
                                            checked />
                                        <label class="form-check-label" for="customCheckc5">warning</label>
                                    </div>
                                    <div class="form-check mb-2">
                                        <input class="form-check-input input-info" type="checkbox" id="customCheckc6"
                                            checked />
                                        <label class="form-check-label" for="customCheckc6">info</label>
                                    </div>
                                    <div class="form-check mb-0">
                                        <input class="form-check-input input-dark" type="checkbox" id="customCheckc7"
                                            checked />
