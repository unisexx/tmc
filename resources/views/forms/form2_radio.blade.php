...
@section('breadcrumb-item-active', 'Radio')
        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form>
                        <div class="mb-3 row">
                            <label class="col-sm-3 text-sm-end col-form-label pt-0">Radio</label>
                            <div class="col-sm-9">
                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="radio" name="group4" value=""
                                        id="flexCheckDefault" />
                                ...
                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="radio" name="group41" value=""
                                ...
                                <div class="form-check mb-2">
                                    ...
                                    <label class="form-check-label" for="flexCheckCheckedDisabled"> Disabled checked radio
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-9">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="group5" value=""
                                        id="customCheckinlh1" />
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="group5" value=""
                                        id="customCheckinlh4" disabled />
                                    <label class="form-check-label" for="customCheckinlh4"> 4 (disabled) </label>
                                </div>
                                <small class="form-text d-block text-muted">Add <code>.form-check-inline</code> to any
                        ...
                        <div class="row mb-0">
                            ...
                            <div class="col-sm-9">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="group6" value=""
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="group6" value=""
                                        id="customCheckinlhstate3" checked />
                                    <label class="form-check-label" for="customCheckinlhstate3"> 3 </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="group6" value=""
                                        id="customCheckinlhstate4" disabled />
                                    <label class="form-check-label" for="customCheckinlhstate4"> 4 (disabled) </label>
                                </div>
                                <small class="form-text d-block text-muted">Add <code>checked</code> attribute to any
                                    <code>.form-check-input</code></small>
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    <form>
                        <div class="row g-4">
                            <div class="col-md-6">
                                <div class="mb-0">
                                    <div class="form-check mb-2">
                                        <input class="form-check-input input-primary" type="radio" id="customCheckc1"
                                            checked />
                                        <label class="form-check-label" for="customCheckc1">primary</label>
                                    </div>
                                    <div class="form-check mb-2">
                                        <input class="form-check-input input-secondary" type="radio" id="customCheckc2"
                                            checked />
                                        <label class="form-check-label" for="customCheckc2">secondary</label>
                                    </div>
                                    <div class="form-check mb-2">
                                        <input class="form-check-input input-success" type="radio" id="customCheckc3"
                                            checked />
                                        <label class="form-check-label" for="customCheckc3">success</label>
                                    </div>
                                    <div class="form-check mb-2">
                                        <input class="form-check-input input-danger" type="radio" id="customCheckc4"
                                            checked />
                                        <label class="form-check-label" for="customCheckc4">danger</label>
                                    </div>
                                    <div class="form-check mb-2">
                                        <input class="form-check-input input-warning" type="radio" id="customCheckc5"
                                            checked />
                                        <label class="form-check-label" for="customCheckc5">warning</label>
                                    </div>
                                    <div class="form-check mb-2">
                                        <input class="form-check-input input-info" type="radio" id="customCheckc6"
                                            checked />
                                        <label class="form-check-label" for="customCheckc6">info</label>
                                    </div>
                                    <div class="form-check mb-0">
                                        <input class="form-check-input input-dark" type="radio" id="customCheckc7"
                                            checked />
