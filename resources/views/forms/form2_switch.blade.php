...
@section('breadcrumb-item-active', 'Switch')
                        ...
                        <div class="col-md-4">
                            <div class="mb-0">
                                ...
                                <div class="form-check form-switch mb-2">
                                    <input type="checkbox" class="form-check-input input-primary" id="customswitchv1-1"
                                        checked />
                                    <label class="form-check-label" for="customswitchv1-1">primary</label>
                                </div>
                                <div class="form-check form-switch mb-2">
                                    <input type="checkbox" class="form-check-input input-secondary" id="customswitchv1-2"
                                        checked />
                                    <label class="form-check-label" for="customswitchv1-2">secondary</label>
                                </div>
                                <div class="form-check form-switch mb-2">
                                    <input type="checkbox" class="form-check-input input-success" id="customswitchv1-3"
                                        checked />
                                    <label class="form-check-label" for="customswitchv1-3">success</label>
                                </div>
                                <div class="form-check form-switch mb-2">
                                    <input type="checkbox" class="form-check-input input-danger" id="customswitchv1-4"
                                        checked />
                                    <label class="form-check-label" for="customswitchv1-4">danger</label>
                                </div>
                                <div class="form-check form-switch mb-2">
                                    <input type="checkbox" class="form-check-input input-warning" id="customswitchv1-5"
                                        checked />
                                    <label class="form-check-label" for="customswitchv1-5">warning</label>
                                </div>
                                <div class="form-check form-switch mb-2">
                                    <input type="checkbox" class="form-check-input input-info" id="customswitchv1-6"
                                        checked />
                                    <label class="form-check-label" for="customswitchv1-6">info</label>
                                </div>
                                <div class="form-check form-switch mb-2">
                                    <input type="checkbox" class="form-check-input input-dark" id="customswitchv1-7"
                                        checked />
                                    <label class="form-check-label" for="customswitchv1-7">dark</label>
                                </div>
                                <small class="form-text text-muted">Use class <code>input-[color name]</code>in
                                    <code>&lt;input&gt;</code> tag</small>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-0">
                                ...
                                <div class="form-check form-switch custom-switch-v1 mb-2">
                                    <input type="checkbox" class="form-check-input input-primary" id="customswitchv2-1"
                                        checked />
                                    <label class="form-check-label" for="customswitchv2-1">primary</label>
                                </div>
                                <div class="form-check form-switch custom-switch-v1 mb-2">
                                    <input type="checkbox" class="form-check-input input-secondary" id="customswitchv2-2"
                                        checked />
                                ...
                                <div class="form-check form-switch custom-switch-v1 mb-2">
                                    <input type="checkbox" class="form-check-input input-danger" id="customswitchv2-4"
                                        checked />
                                    <label class="form-check-label" for="customswitchv2-4">danger</label>
                                </div>
                                <div class="form-check form-switch custom-switch-v1 mb-2">
                                    <input type="checkbox" class="form-check-input input-warning" id="customswitchv2-5"
                                        checked />
                                    <label class="form-check-label" for="customswitchv2-5">warning</label>
                                </div>
                                <div class="form-check form-switch custom-switch-v1 mb-2">
                                    <input type="checkbox" class="form-check-input input-info" id="customswitchv2-6"
                                        checked />
                                    <label class="form-check-label" for="customswitchv2-6">info</label>
                                </div>
                                <div class="form-check form-switch custom-switch-v1 mb-2">
                                    <input type="checkbox" class="form-check-input input-dark" id="customswitchv2-7"
                                        checked />
                                    <label class="form-check-label" for="customswitchv2-7">dark</label>
                                </div>
                                <small class="form-text text-muted">Use class <code>custom-switch-v1</code>in
                                    <code>&lt;div&gt;</code> tag</small>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-0">
                                ...
                                <hr />
                                <div class="form-check form-switch custom-switch-v1 mb-2">
                                    <input type="checkbox" class="form-check-input input-light-primary"
                                        id="customswitchlightv1-1" checked />
                                    <label class="form-check-label" for="customswitchlightv1-1">primary</label>
                                </div>
                                <div class="form-check form-switch custom-switch-v1 mb-2">
                                    <input type="checkbox" class="form-check-input input-light-secondary"
                                        id="customswitchlightv1-2" checked />
                                    <label class="form-check-label" for="customswitchlightv1-2">secondary</label>
                                </div>
                                <div class="form-check form-switch custom-switch-v1 mb-2">
                                    <input type="checkbox" class="form-check-input input-light-success"
                                        id="customswitchlightv1-3" checked />
                                    <label class="form-check-label" for="customswitchlightv1-3">success</label>
                                </div>
                                <div class="form-check form-switch custom-switch-v1 mb-2">
                                    <input type="checkbox" class="form-check-input input-light-danger"
                                        id="customswitchlightv1-4" checked />
                                    <label class="form-check-label" for="customswitchlightv1-4">danger</label>
                                </div>
                                <div class="form-check form-switch custom-switch-v1 mb-2">
                                    <input type="checkbox" class="form-check-input input-light-warning"
                                        id="customswitchlightv1-5" checked />
                                    <label class="form-check-label" for="customswitchlightv1-5">warning</label>
                                </div>
                                <div class="form-check form-switch custom-switch-v1 mb-2">
                                    <input type="checkbox" class="form-check-input input-light-info"
                                        id="customswitchlightv1-6" checked />
                                    <label class="form-check-label" for="customswitchlightv1-6">info</label>
                                </div>
                                <div class="form-check form-switch custom-switch-v1 mb-2">
                                    <input type="checkbox" class="form-check-input input-light-dark"
                                        id="customswitchlightv1-7" checked />
                ...
                <div class="card-body">
                    <form>
                        ...
                        <div class="mb-0">
                            ...
                            <div class="form-check form-switch custom-switch-v1 form-check-inline">
                                <input type="checkbox" class="form-check-input input-primary" id="customCheckinl4"
                                    checked />
                            ...
                            <div class="form-check form-switch custom-switch-v1 form-check-inline">
                                <input type="checkbox" class="form-check-input input-primary" id="customCheckinl6"
                                    checked />
                    ...
                    <form>
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="form-check form-switch custom-switch-v1 mb-2">
                                    <input type="checkbox" class="form-check-input input-primary" id="customCheckdefh3"
                                        disabled />
                                    <label class="form-check-label" for="customCheckdefh3">Disabled</label>
                                </div>
                                <div class="form-check form-switch custom-switch-v1 mb-2">
                                    <input type="checkbox" class="form-check-input input-primary" id="customCheckdefh4"
                                        checked />
                        ...
                        <div class="mb-0 row align-items-center">
                            ...
                            <div class="col-sm-9">
                                <div class="form-check form-switch custom-switch-v1 form-check-inline">
                                    <input type="checkbox" class="form-check-input input-primary" id="customCheckinlh4"
                                        checked />
                                ...
                                <div class="form-check form-switch custom-switch-v1 form-check-inline">
                                    <input type="checkbox" class="form-check-input input-primary" id="customCheckinlh6"
                                        checked />
                ...
                <div class="card-body">
                    <form>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check form-switch switch-lg">
                                <input type="checkbox" class="form-check-input input-primary f-16"
                                    id="customCheckdefout3" disabled />
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check form-switch">
                                <input type="checkbox" class="form-check-input input-primary" id="customCheckc1"
                                    checked />
                                <label class="form-check-label" for="customCheckc1">primary</label>
                            </div>
                            <div class="form-check form-switch">
                                <input type="checkbox" class="form-check-input input-secondary" id="customCheckc2"
                                    checked />
                                <label class="form-check-label" for="customCheckc2">secondary</label>
                            </div>
                            <div class="form-check form-switch">
                                <input type="checkbox" class="form-check-input input-success" id="customCheckc3"
                                    checked />
                                <label class="form-check-label" for="customCheckc3">success</label>
                            </div>
                            <div class="form-check form-switch">
                                <input type="checkbox" class="form-check-input input-danger" id="customCheckc4"
                                    checked />
                                <label class="form-check-label" for="customCheckc4">danger</label>
                            </div>
                            <div class="form-check form-switch">
                                <input type="checkbox" class="form-check-input input-warning" id="customCheckc5"
                                    checked />
                        ...
                        <div class="mb-0">
                            ...
                            <div class="form-check form-switch">
                                <input type="checkbox" class="form-check-input input-light-info" id="customCheckclight6"
                                    checked />
                                <label class="form-check-label" for="customCheckclight6">info</label>
                            </div>
                            <div class="form-check form-switch">
                                <input type="checkbox" class="form-check-input input-light-dark" id="customCheckclight7"
                                    checked />
