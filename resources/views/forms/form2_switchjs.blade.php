...
@section('breadcrumb-item-active', 'Bootstrap Switch')

@section('css')
    <!-- [Page specific CSS] start -->
    <link rel="stylesheet" href="{{ URL::asset('build/css/plugins/bootstrap-switch-button.min.css') }}">
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="card bg-dark">
                ...
                <div class="card-body">
                    ...
                    <input type="checkbox" data-toggle="switchbutton" checked data-onstyle="light" data-offstyle="dark"
                        data-style="border" />
                    <input type="checkbox" data-toggle="switchbutton" checked data-onstyle="dark" data-offstyle="light"
                        data-style="border" />
                </div>
            </div>
        </div>
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    <input type="checkbox" data-toggle="switchbutton" checked data-onlabel="Ready" data-offlabel="Not Ready"
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    <input type="checkbox" data-toggle="switchbutton" checked data-onlabel="<i class='fa fa-play'></i> Play"
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    <input type="checkbox" data-toggle="switchbutton" checked data-onlabel="Hello<br>World"
                        data-offlabel="Goodbye<br>World" />
                </div>
            </div>
        </div>
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header">
                    ...
                    <small>Transition speed can be easily controlled with css <code>transition</code> property on
                        <code>.switch-group</code>. You
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-check ps-0">
                        <input id="stackedCheck1" class="form-check-input" type="checkbox" data-toggle="switchbutton"
                            checked />
                        <label for="stackedCheck1" class="form-check-label">Enabled</label>
                    </div>
                    <div class="form-check ps-0">
                        <input id="stackedCheck2" class="form-check-input" type="checkbox" data-toggle="switchbutton"
                            disabled />
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><button class="btn btn-outline-secondary btn-sm"
                                            onclick="document.getElementById('switch-demo').switchButton()">Initialize</button>
                                    </td>
                                ...
                                <tr>
                                    <td>destroy</td>
                                    <td><button class="btn btn-outline-secondary btn-sm"
                                            onclick="document.getElementById('switch-demo').switchButton('destroy')">Destroy</button>
                                    </td>
                                ...
                                <tr>
                                    <td>on</td>
                                    <td><button class="btn btn-outline-secondary btn-sm"
                                            onclick="document.getElementById('switch-demo').switchButton('on')">On</button>
                                    </td>
                                ...
                                <tr>
                                    <td>off</td>
                                    <td><button class="btn btn-outline-secondary btn-sm"
                                            onclick="document.getElementById('switch-demo').switchButton('off')">Off</button>
                                    </td>
                                ...
                                <tr>
                                    <td>toggle</td>
                                    <td><button class="btn btn-outline-secondary btn-sm"
                                            onclick="document.getElementById('switch-demo').switchButton('toggle')">Toggle</button>
                                    </td>
                                ...
                                <tr>
                                    <td>enable</td>
                                    <td><button class="btn btn-outline-secondary btn-sm"
                                            onclick="document.getElementById('switch-demo').switchButton('enable')">Enable</button>
                                    </td>
                                ...
                                <tr>
                                    <td>disable</td>
                                    <td><button class="btn btn-outline-secondary btn-sm"
                                            onclick="document.getElementById('switch-demo').switchButton('disable')">Disable</button>
                                    </td>
...
@section('scripts')
    ...
    <script src="{{ URL::asset('build/js/plugins/bootstrap-switch-button.min.js') }}"></script>
    <script>
        (function() {
