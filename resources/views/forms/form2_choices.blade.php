        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form>
                        <div class="mb-3 row">
                            <label class="col-form-label col-lg-4 col-sm-12 text-lg-end">Limited to 5 values with remove
                                button</label>
                        ...
                        <div class="mb-3 row">
                            <label class="col-form-label col-lg-4 col-sm-12 text-lg-end">Unique values only, no
                                pasting</label>
                            <div class="col-lg-6 col-md-11 col-sm-12">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-6 col-md-11 col-sm-12">
                                <input class="form-control" id="choices-text-email-filter" type="text"
                        ...
                        <div class="mb-3 row">
                            <label class="col-form-label col-lg-4 col-sm-12 text-lg-end">Prepends and appends a value to
                                each items return value</label>
                            <div class="col-lg-6 col-md-11 col-sm-12">
                                <input class="form-control" id="choices-text-prepend-append-value" type="text"
                                    value="preset-1, preset-2" placeholder="This is a placeholder" />
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label class="col-form-label col-lg-4 col-sm-12 text-lg-end">Preset values passed through
                                options</label>
                            <div class="col-lg-6 col-md-11 col-sm-12">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-6 col-md-11 col-sm-12">
                                <input data-trigger class="form-control" id="choices-text-rtl" type="text"
                                    value="Value 1, Value 2" dir="rtl" />
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form>
                        ...
                        <div class="mb-3 row">
                            <label class="col-form-label col-lg-4 col-sm-12 text-lg-end">Options from remote source (Fetch
                                API) &amp; limited to 5</label>
                            <div class="col-lg-6 col-md-11 col-sm-12">
                                <select class="form-control" name="choices-multiple-remote-fetch"
                                    id="choices-multiple-remote-fetch" multiple></select>
                                <small>If the following example do not load, the rate limit has probably been reached. Try
                                    again later!</small>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label class="col-form-label col-lg-4 col-sm-12 text-lg-end">Right-to-left</label>
                            <div class="col-lg-6 col-md-11 col-sm-12">
                                <select class="form-control" data-trigger name="choices-multiple-rtl"
                                    id="choices-multiple-rtl" multiple dir="rtl">
                                    <option value="Choice 1" selected>Choice 1</option>
                                    <option value="Choice 2">Choice 2</option>
                                    <option value="Choice 3">Choice 3</option>
                                    <option value="Choice 4" disabled>Choice 4</option>
                        ...
                        <div class="mb-3 row">
                            <label class="col-form-label col-lg-4 col-sm-12 text-lg-end">Use label in event
                                (add/remove)</label>
                            <div class="col-lg-6 col-md-11 col-sm-12">
                    ...
                    <form>
                        ...
                        <div class="mb-3 row">
                            <label class="col-form-label col-lg-4 col-sm-12 text-lg-end">Options from remote source (Fetch
                                API)</label>
                            <div class="col-lg-6 col-md-11 col-sm-12">
                                <select class="form-control" name="choices-single-remote-fetch"
                                    id="choices-single-remote-fetch">
                                    <option value="">Pick an Arctic Monkeys' record</option>
                                </select>
                                <small>If the following two examples do not load, the rate limit has probably been reached.
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-6 col-md-11 col-sm-12">
                                <select class="form-control" name="choices-single-remove-xhr"
                        ...
                        <div class="mb-3 row">
                            <label class="col-form-label col-lg-4 col-sm-12 text-lg-end">Right-to-left</label>
                            <div class="col-lg-6 col-md-11 col-sm-12">
                                <select class="form-control" data-trigger name="choices-single-rtl"
                                    id="choices-single-rtl" dir="rtl">
                                    <option value="Choice 1">Choice 1</option>
                                    <option value="Choice 2">Choice 2</option>
                                    <option value="Choice 3">Choice 3</option>
                                </select>
                        ...
                        <div class="mb-3 row">
                            <label class="col-form-label col-lg-4 col-sm-12 text-lg-end">Options added via config with no
                                search</label>
                            <div class="col-lg-6 col-md-11 col-sm-12">
                        ...
                        <div class="mb-3 row">
                            <label class="col-form-label col-lg-4 col-sm-12 text-lg-end">Option and option groups added via
                                config</label>
                            <div class="col-lg-6 col-md-11 col-sm-12">
                                <select class="form-control" name="choices-single-preset-options"
                                    id="choices-single-preset-options"></select>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label class="col-form-label col-lg-4 col-sm-12 text-lg-end">Option selected via config with
                                custom properties</label>
                            <div class="col-lg-6 col-md-11 col-sm-12">
                                <select class="form-control" name="choices-single-selected-option"
                                    id="choices-single-selected-option"></select>
                                <small>Try searching for 'fantastic', "Label 3" should display</small>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label class="col-form-label col-lg-4 col-sm-12 text-lg-end">Option searchable by custom
                                properties via <code>data-custom-properties</code> attribute</label>
                            <div class="col-lg-6 col-md-11 col-sm-12">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-6 col-md-11 col-sm-12">
                                <select class="form-control" name="choices-single-custom-templates"
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-6 col-md-11 col-sm-12">
                                ...
                                <small>
                                    Below is an example of how you could have two select inputs depend on each other. 'Tube
                                    stations' will only be
                ...
                <div class="card-body">
                    <form>
                        ...
                        <div class="row mb-0">
                            ...
                            <div class="col-lg-6 col-md-11 col-sm-12">
                                <button class="btn btn-light-warning" type="reset"><i class="me-2"
                                        data-feather="alert-triangle"></i> Reset</button>
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    return {
                        item: function(classNames, data) {
                            return strToEl(
                                ...
                                ' ' +
                                String(data.highlighted ? classNames.highlightedState :
                        ...
                        choice: function(classNames, data) {
                            return strToEl(
                                ...
                                ' ' +
                                String(data.disabled ? classNames.itemDisabled : classNames
                                    .itemSelectable) +
                                '"\
                                    data-select-text="' +
