                                    ...
                                    <div class="border card p-3">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label d-block" for="customCheckdef1">
                                                <span>
                                                    <span class="h5 d-block"><strong class="float-end"><span
                                                                class="badge bg-light-primary">Free</span></strong>Trial
                                                        plan</span>
                                            ...
                                            <label class="form-check-label d-block" for="customCheckdef2">
                                                <span>
                                                    <span class="h5 d-block"><strong
                                                            class="float-end">$&nbsp;12.46</strong>Premium plan</span>
                                                    <span class="f-12 text-muted">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-check my-2">
                                        <input type="radio" name="radio2" class="form-check-input input-primary"
                                            id="customCheckmem1" />
                                        <label class="form-check-label" for="customCheckmem1">
                                            <span>
                                                <span class="h5 d-block">SUPERNET 50</span>
                                                <span class="f-12 text-muted"> 360 days Speed upto 50 Mbps Unlimited( Rs.
                                                    5094 ) </span>
                                            </span>
                                        </label>
                                    </div>
                                    ...
                                    <div class="form-check my-2">
                                        ...
                                        <label class="form-check-label" for="customCheckmem2">
                                            <span>
                                                ...
                                                <span class="f-12 text-muted"> 360 days Speed upto 75 Mbps 6000 GB( Rs. 6042
                                                    ) </span>
                                            </span>
                                        </label>
                                    </div>
                            ...
                            <div class="col-sm-9">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="border card p-3">
                                            <div class="form-check">
                                                <input type="radio" name="radio3" class="form-check-input input-primary"
                                        ...
                                        <div class="border card p-3">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label d-block" for="customCheckdefhor2">
                                                    <span>
                                                        <span class="h5 d-block"><strong
                                                                class="float-end">$&nbsp;8.00</strong>Premium plan</span>
                                                        <span class="f-12 text-muted">
                                                            Free server unlimited approx 255k+ Premium collection<br />
                                                            (Download unlimited premium items)
                                                        </span>
                        ...
                        <div class="row mb-0 pt-3">
                            ...
                            <div class="col-sm-9">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-check my-2">
                                            <input type="radio" name="radio4" class="form-check-input input-primary"
                                                id="customCheckmemhor1" />
                                            <label class="form-check-label" for="customCheckmemhor1">
                                                <span>
                                                    <span class="h5 d-block">SUPERNET 50</span>
                                                    <span class="f-12 text-muted"> 360 days Speed upto 50 Mbps Unlimited(
                                                        Rs. 5094 ) </span>
                                                </span>
                                            </label>
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-check my-2">
                                            <input type="radio" name="radio4" class="form-check-input input-primary"
                                                id="customCheckmemhor2" />
                                            <label class="form-check-label" for="customCheckmemhor2">
                                                <span>
                                                    <span class="h5 d-block">SUPERSONIC 75</span>
                                                    <span class="f-12 text-muted"> 360 days Speed upto 75 Mbps 6000 GB( Rs.
                                                        6042 ) </span>
                                                </span>
                                            </label>
                                        </div>
