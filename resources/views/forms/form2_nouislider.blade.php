                    ...
                    <form>
                        <div class="row mb-5">
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12">
                                <div class="row align-items-center g-3">
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="pc-no_ui_slider-1-input"
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12">
                                <div class="row align-items-center g-3">
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control mb-2" id="event-start"
                                            placeholder="Date" />
                                ...
                                <small class="form-text text-muted">dates to numerical ranges, and then use the update event
                                    to display them in a pretty format.</small>
                            </div>
                        </div>

                        <div class="row mb-5">
                            <label class="col-form-label col-lg-3 col-sm-12 text-lg-end">Moving the slider by clicking
                                pips</label>
                            <div class="col-lg-6 col-md-12 col-sm-12">
                                <div class="row align-items-center g-3">
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="pc-no_ui_slider-10-input"
                                            placeholder="Currency" />
                                    </div>
                                    <div class="col-sm-8 mb-4">
                                        <div id="pc-no_ui_slider-10" class="pc-nouislider pc-no_ui_slider--handle-danger">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12">
                                <div class="row align-items-center g-3">
                                    <div class="col-6 col-sm-3 pb-5 pb-sm-0">
                                        <input type="text" class="form-control" id="pc-no_ui_slider-3-input"
                                            placeholder="Quantity" />
                                    </div>
                                    <div class="col-6 col-sm-3 pb-5 pb-sm-0">
                                        <input type="text" class="form-control" id="pc-no_ui_slider-3.1-input"
                                            placeholder="Quantity" />
                                    </div>
                                    <div class="col-sm-6">
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12">
                                <div class="row align-items-center g-3">
                                    ...
                                    <div class="col-6 col-sm-3">
                                        <input type="number" class="form-control" id="pc-no_ui_slider-input-number"
                                            placeholder="Quantity" />
                                    </div>
                                    <div class="col-sm-6">
                                        <div id="pc-no_ui_slider-4"
                                            class="pc-nouislider pc-no_ui_slider--handle-primary pc-no_ui_slider--connect-warning">
                                        </div>
                                    </div>
                                </div>
                                <small class="form-text text-muted">noUiSlider's <code>'update'</code> method is useful for
                                    synchronizing with other elements</small>
                            </div>
                        </div>
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12">
                                <div class="row align-items-center mb-4 g-3">
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="pc-no_ui_slider-5-input"
                                            placeholder="Quantity" />
                                    </div>
                                ...
                                <small class="form-text text-muted">If you want to disable the edges of a slider, the set
                                    event can be used to reset the value if a limit is
                                    passed.</small>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12">
                                <div class="row mb-3 g-3">
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control mb-3" id="pc-no_ui_slider-6-input"
                                            placeholder="Quantity" />
                                    </div>
                                    <div class="col-sm-8">
    ...
    <script>
        ...
        (function() {
            ...
            function formatDate(date) {
                return (
                    weekdays[date.getDay()] + ', ' + date.getDate() + nth(date.getDate()) + ' ' + months[date
