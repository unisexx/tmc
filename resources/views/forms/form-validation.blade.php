...
@section('breadcrumb-item-active', 'Form Validation')
                ...
                <div class="card-body">
                    <form class="validate-me" id="validate-me" data-validate>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-6">
                                <input type="url" name="url" id="url" class="form-control"
                                    data-bouncer-message="The URL is a missing a TLD (for example, .com)." required />
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-6">
                                <input type="url" name="url_not_ld" id="url_not_ld" class="form-control"
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-6">
                                <input type="number" class="form-control" step="any" name="integer" id="integer"
                                    required />
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-6">
                                <input type="number" class="form-control" min="2" max="7"
                                    name="number_min_max" id="number_min_max" required />
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <small class="form-text text-muted">At least 1 uppercase character, 1 lowercase character,
                                    and 1 number</small>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-6">
                                <input type="password" name="confirm-password" id="confirm-password"
                                    data-bouncer-match="#password" class="form-control"
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-6">
                                <input class="form-control" type="text" minlength="3" maxlength="9"
                                    name="text_min_max" id="text_min_max" required />
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="radio" id="radio-2"
                                        required />
                        ...
                        <div class="mb-3 row align-items-center">
                            ...
                            <div class="col-lg-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="checkbox-1" id="checkbox-1"
                                        required />
...
@section('scripts')
    ...
    <script src="{{ URL::asset('build/js/plugins/bouncer.min.js') }}"></script>
    <script src="{{ URL::asset('build/js/forms/form-validation.js') }}"></script>
