...
@section('title', 'Inline Ckeditor')
@section('breadcrumb-item', 'Forms')

@section('breadcrumb-item-active', 'Inline Ckeditor')
                ...
                <div class="card-body">
                    <div id="cke5-inline-demo">
                        ...
                        <div class="ck-content ck-content1" data-inline-inject="true">
                            ...
                            <p>The capital city of <a href="https://en.wikipedia.org/wiki/Malta" target="_blank"
                                    rel="noopener">Malta</a> is the top
                                destination this summer. It’s home to a cutting-edge contemporary architecture, baroque
                                masterpieces, delicious local
                                cuisine and at least 8 months of sun. It’s also a top destination for filmmakers, so you can
                                take a tour through
...
@section('scripts')
    ...
    <!-- Ckeditor js -->
    <script src="{{ URL::asset('build/js/plugins/ckeditor/inline/ckeditor.js') }}"></script>
    <script>
        (function() {
