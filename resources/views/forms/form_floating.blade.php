...
@section('breadcrumb-item-active', 'Floating Label')
...
@section('content')
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            <form class="form-floating mb-0">
                                <input type="email" class="form-control is-valid" id="floatingInputInvalid"
                                    placeholder="name@example.com" value="test@example.com" />
                        ...
                        <div class="col-md-6">
                            <form class="form-floating mb-0">
                                <input type="email" class="form-control is-invalid" id="floatingInputInvalid1"
                                    placeholder="name@example.com" value="test@example.com" />
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            <div class="form-floating mb-0">
                                <textarea class="form-control is-valid" rows="3" placeholder="Leave a comment here"
    ...
    Valid textarea</textarea>
                        ...
                        <div class="col-md-6">
                            <form class="form-floating mb-0">
                                <textarea class="form-control is-invalid" rows="3" placeholder="Leave a comment here"
                                    id="floatingTextarea21">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            <div class="form-floating mb-0">
                                <select class="form-select is-valid" id="floatingselect1"
                        ...
                        <div class="col-md-6">
                            <form class="form-floating mb-0">
                                <select class="form-select is-invalid" id="floatingselect2"
                                    aria-label="Floating label select example">
                                    <option selected>Open this select menu</option>
                                    <option value="1">One</option>
                                    <option value="2">Two</option>
