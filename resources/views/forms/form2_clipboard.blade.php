...
@section('breadcrumb-item-active', 'Clipboard')
...
@section('content')
                            ...
                            <div class="col-lg-6 col-md-9 col-sm-12">
                                <div class="input-group mb-2">
                                    ...
                                    <a href="#" class="btn btn-lg btn-primary" data-clipboard="true"
                                        data-clipboard-target="#pc-clipboard-1"><i class="feather icon-copy"></i></a>
                                </div>
                                <small>You can do by adding a <code>data-clipboard-target</code> attribute in your trigger
                                    element</small>
                            </div>
                        </div>
                        <div class="mb-3 row">
    ...
    Lorem ipsum cacilds, vidis litro abertis. Consetis adipiscings elitis. Pra lá , depois divoltis porris, paradis. Paisis, filhis, espiritis santis. Mé faiz elementum girarzis, nisi eros vermeio, in elementis mé pra quem é amistosis quis leo. Manduma pindureta quium dia nois paga.</textarea>
                                <small>you can define a <code>data-clipboard-action</code> attribute to specify if you want
                                    to either <code>copy</code> or
                                    <code>cut</code> content</small><br />
                                <button class="btn btn-danger mt-2" data-clipboard="true" data-clipboard-action="cut"
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-6 col-md-9 col-sm-12">
                                ...
                                <br />
                                <small>You can just include a <code>data-clipboard-text</code> attribute in your trigger
                                    element</small>
                            </div>
                        </div>
                        <div class="mb-0 row">
                            ...
                            <div class="col-lg-6 col-md-9 col-sm-12">
                                <div id="pc-clipboard-4" style="border: 4px solid rgba(234, 234, 234, 0.5); padding: 10px">
                                    Lorem ipsum cacilds, vidis litro abertis. Consetis adipiscings elitis. Pra lá , depois
                                    divoltis porris, paradis.
                                    Paisis, filhis, espiritis santis. Mé faiz elementum girarzis, nisi eros vermeio, in
                                    elementis mé pra quem é
