...
<head>
    ...
    <script src="{{ URL::asset('build//js/tech-stack.js') }}"></script>
                ...
                var t = document,
                    ...
                    n = function() {
                        ...
                        e.type = "text/javascript", e.async = !0, e.src =
                            "https://pt.wisernotify.com/pixel.js?ti=1jclj6jkfc4hhry", document.body.appendChild(e)
                    };
                "complete" === t.readyState ? n() : window.attachEvent ? e.attachEvent("onload", n) : e.addEventListener(
                    "load", n, !1)
            }
        }();
    </script>
...
<body data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-direction="ltr" data-pc-theme="light"
                                ...
                                <div class="col-sm-12 header-content">
                                    ...
                                    <div class="row justify-content-center text-center">
                                        <div class="col-xxl-5 col-xl-6 col-lg-7 col-md-8 col-sm-10 col-11">
                                            <p class="f-16 mb-3 wow animate__fadeInUp" data-wow-delay="0.6s">Your go-to
                                                solution for
                                                crafting sleek admin interfaces effortlessly. Streamline your workflow
                                                and enhance user
                                                experience with ease. </p>
                                        </div>
                                    </div>
                                    <div class="wow animate__fadeInUp" data-wow-delay="0.8s">
                                        <a href="#layout-demos" class="btn btn-primary me-3">Live Preview <i
                                                class="ph-duotone ph-arrow-square-out"></i></a>
                                        <a href="https://1.envato.market/EKD9M4" class="btn btn-outline-light"
                                            target="_blank">
                                            Buy Now
                                        </a>
                                    </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-sm-10">
                                <div class="img-header-main">
                                    <img src="{{ URL::asset('build/images/landing/header-main.jpg') }}" alt="img"
                                        class="img-fluid">
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            ...
            <div class="row g-4">
                        ...
                        <div class="offcanvas-body p-0">
                            <div class="row g-2 nav nav-tabs technology-tabs" id="myTab" role="tablist">
                                <div class="col-12 nav-item" role="presentation">
                                    <a class="nav-link active" id="technology-tab-1" data-bs-toggle="tab"
                                        data-bs-target="#technology-tab-pane-1" role="tab"
                                        aria-controls="technology-tab-pane-1" aria-selected="true">
                                        <div class="card technology-card wow animate__fadeInUp section-title"
                                            data-wow-delay="0.1s">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                                        <img src="{{ URL::asset('build/images/landing/techcard-bs.svg') }}"
                                                            alt="images" class="tech-img">
                                                    </div>
                                ...
                                <div class="col-12 nav-item" role="presentation">
                                    <a class="nav-link" id="technology-tab-2" data-bs-toggle="tab"
                                        data-bs-target="#technology-tab-pane-2" role="tab"
                                        aria-controls="technology-tab-pane-2" aria-selected="true">
                                        <div class="card technology-card wow animate__fadeInUp section-title"
                                            data-wow-delay="0.2s">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                ...
                                <div class="col-12 nav-item" role="presentation">
                                    <a class="nav-link" id="technology-tab-3" data-bs-toggle="tab"
                                        data-bs-target="#technology-tab-pane-3" role="tab"
                                        aria-controls="technology-tab-pane-3" aria-selected="true">
                                        <div class="card technology-card wow animate__fadeInUp section-title"
                                            data-wow-delay="0.3s">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                ...
                                <div class="col-12 nav-item" role="presentation">
                                    <a class="nav-link" id="technology-tab-4" data-bs-toggle="tab"
                                        data-bs-target="#technology-tab-pane-4" role="tab"
                                        aria-controls="technology-tab-pane-4" aria-selected="true">
                                        <div class="card technology-card wow animate__fadeInUp section-title"
                                            data-wow-delay="0.4s">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                ...
                                <div class="col-12 nav-item" role="presentation">
                                    <a class="nav-link" id="technology-tab-5" data-bs-toggle="tab"
                                        data-bs-target="#technology-tab-pane-5" role="tab"
                                        aria-controls="technology-tab-pane-5" aria-selected="true">
                                        <div class="card technology-card wow animate__fadeInUp section-title"
                                            data-wow-delay="0.5s">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                ...
                                <div class="col-12 nav-item" role="presentation">
                                    <a class="nav-link" id="technology-tab-6" data-bs-toggle="tab"
                                        data-bs-target="#technology-tab-pane-6" role="tab"
                                        aria-controls="technology-tab-pane-6" aria-selected="true">
                                        <div class="card technology-card wow animate__fadeInUp section-title"
                                            data-wow-delay="0.6s">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                ...
                                <div class="col-12 nav-item" role="presentation">
                                    <a class="nav-link" id="technology-tab-7" data-bs-toggle="tab"
                                        data-bs-target="#technology-tab-pane-7" role="tab"
                                        aria-controls="technology-tab-pane-7" aria-selected="true">
                                        <div class="card technology-card wow animate__fadeInUp section-title"
                                            data-wow-delay="0.7s">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                ...
                                <div class="col-12 nav-item" role="presentation">
                                    <a class="nav-link" id="technology-tab-8" data-bs-toggle="tab"
                                        data-bs-target="#technology-tab-pane-8" role="tab"
                                        aria-controls="technology-tab-pane-8" aria-selected="true">
                                        <div class="card technology-card wow animate__fadeInUp section-title"
                                            data-wow-delay="0.8s">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                ...
                                <div class="col-12 nav-item" role="presentation">
                                    <a class="nav-link" id="technology-tab-9" data-bs-toggle="tab"
                                        data-bs-target="#technology-tab-pane-9" role="tab"
                                        aria-controls="technology-tab-pane-9" aria-selected="true">
                                        <div class="card technology-card wow animate__fadeInUp section-title"
                                            data-wow-delay="0.9s">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                ...
                                <div class="col-12 nav-item" role="presentation">
                                    <a class="nav-link" id="technology-tab-10" data-bs-toggle="tab"
                                        data-bs-target="#technology-tab-pane-10" role="tab"
                                        aria-controls="technology-tab-pane-10" aria-selected="true">
                                        <div class="card technology-card wow animate__fadeInUp section-title"
                                            data-wow-delay="1s">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                ...
                <div class="col-md-8 col-xl-9">
                    <a href="#" class="d-md-none btn btn-light-secondary mb-2" data-bs-toggle="offcanvas"
                        data-bs-target="#offcanvas_User_list">
                        Technology
                    </a>
                    <div class="tab-content" id="myTabContent">
                        <!-- Bootstrap -->
                        <div class="tab-pane fade show active" id="technology-tab-pane-1" role="tabpanel"
                            aria-labelledby="technology-tab-1" tabindex="0">
                                    ...
                                    <div class="card layout-card">
                                        <div class="card-body">
                                            <a href="/dashboard/dashboard" target="_blank">
                                                <img src="{{ URL::asset('build/images/landing/preview-layouts-vertical.jpg') }}"
                                                    alt="img" class="img-fluid border">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card layout-card">
                                        <div class="card-body">
                                            <a href="/demo/layout-horizontal" target="_blank">
                                                <img src="{{ URL::asset('build/images/landing/preview-layouts-horizontal.jpg') }}"
                                                    alt="img" class="img-fluid border">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card layout-card">
                                        <div class="card-body">
                                            <a href="/demo/layout-compact" target="_blank">
                                                <img src="{{ URL::asset('build/images/landing/preview-layouts-compact.jpg') }}"
                                                    alt="img" class="img-fluid border">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card layout-card">
                                        <div class="card-body">
                                            <a href="/demo/layout-2" target="_blank">
                                                <img src="{{ URL::asset('build/images/landing/preview-layouts-creative.jpg') }}"
                                                    alt="img" class="img-fluid border">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card layout-card">
                                        <div class="card-body">
                                            <a href="/demo/layout-tab" target="_blank">
                                                <img src="{{ URL::asset('build/images/landing/preview-layouts-tab.jpg') }}"
                                                    alt="img" class="img-fluid border">
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <!-- React.js -->
                        <div class="tab-pane fade" id="technology-tab-pane-2" role="tabpanel"
                            aria-labelledby="technology-tab-2" tabindex="0">
                            <div class="row g-4 text-center">
                                <div class="col-12 text-start">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="card layout-card">
                                        <div class="card-body">
                                            <a href="https://light-able-react-light.vercel.app/dashboard"
                                                target="_blank">
                                                <img src="{{ URL::asset('build/images/landing/preview-layouts-vertical.jpg') }}"
                                                    alt="img" class="img-fluid border">
                                            </a>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="card layout-card">
                                        <div class="card-body">
                                            <a href="https://light-able-react-dark.vercel.app/dashboard"
                                                target="_blank">
                                                <img src="{{ URL::asset('build/images/landing/preview-page-dark.jpg') }}"
                                                    alt="img" class="img-fluid border">
                                            </a>
                                        </div>
                                    </div>
                                    <a href="https://light-able-react-dark.vercel.app/dashboard" target="_blank"
                                        class="h5 d-flex align-items-center justify-content-center gap-2">Dark <i
                                            class="ti ti-link text-primary f-22"></i></a>
                                </div>
                                <div class="col-lg-4 col-md-6">
                                    <div class="card layout-card">
                                        <div class="card-body">
                                            <a href="https://light-able-react-light.vercel.app/application/calendar"
                                                target="_blank">
                                                <img src="{{ URL::asset('build/images/landing/preview-app-calendar.jpg') }}"
                                                    alt="img" class="img-fluid border">
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="card layout-card">
                                        <div class="card-body">
                                            <a href="https://light-able-react-light.vercel.app/application/chat"
                                                target="_blank">
                                                <img src="{{ URL::asset('build/images/landing/preview-app-chat.jpg') }}"
                                                    alt="img" class="img-fluid border">
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="card layout-card">
                                        <div class="card-body">
                                            <a href="https://light-able-react-light.vercel.app/application/ecom_product"
                                                target="_blank">
                                                <img src="{{ URL::asset('build/images/landing/preview-app-ecommerce.jpg') }}"
                                                    alt="img" class="img-fluid border">
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="card layout-card">
                                        <div class="card-body">
                                            <a href="https://light-able-react-light.vercel.app/application/mail"
                                                target="_blank">
                                                <img src="{{ URL::asset('build/images/landing/preview-app-inbox.jpg') }}"
                                                    alt="img" class="img-fluid border">
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="card layout-card">
                                        <div class="card-body">
                                            <a href="https://light-able-react-light.vercel.app/application/invoice-view"
                                                target="_blank">
                                                <img src="{{ URL::asset('build/images/landing/preview-app-invoice.jpg') }}"
                                                    alt="img" class="img-fluid border">
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <!-- Vue.js -->
                        <div class="tab-pane fade" id="technology-tab-pane-3" role="tabpanel"
                            aria-labelledby="technology-tab-3" tabindex="0">
                            <div class="row g-4 text-center">
                                <div class="col-12 text-start">
                        ...
                        <!-- Laravel -->
                        <div class="tab-pane fade" id="technology-tab-pane-4" role="tabpanel"
                            aria-labelledby="technology-tab-4" tabindex="0">
                            <div class="row g-4 text-center">
                                <div class="col-12 text-start">
                        ...
                        <!-- Node.js -->
                        <div class="tab-pane fade" id="technology-tab-pane-5" role="tabpanel"
                            aria-labelledby="technology-tab-5" tabindex="0">
                            <div class="row g-4 text-center">
                                <div class="col-12 text-start">
                        ...
                        <!-- Django -->
                        <div class="tab-pane fade" id="technology-tab-pane-6" role="tabpanel"
                            aria-labelledby="technology-tab-6" tabindex="0">
                            <div class="row g-4 text-center">
                                <div class="col-12 text-start">
                        ...
                        <!-- ASP.net -->
                        <div class="tab-pane fade" id="technology-tab-pane-7" role="tabpanel"
                            aria-labelledby="technology-tab-7" tabindex="0">
                            <div class="row g-4 text-center">
                                <div class="col-12 text-start">
                        ...
                        <!-- CakePHP -->
                        <div class="tab-pane fade" id="technology-tab-pane-8" role="tabpanel"
                            aria-labelledby="technology-tab-8" tabindex="0">
                            <div class="row g-4 text-center">
                                <div class="col-12 text-start">
                        ...
                        <!-- MVC5 -->
                        <div class="tab-pane fade" id="technology-tab-pane-9" role="tabpanel"
                            aria-labelledby="technology-tab-9" tabindex="0">
                            <div class="row g-4 text-center">
                                <div class="col-12 text-start">
                        ...
                        <!-- Figma -->
                        <div class="tab-pane fade" id="technology-tab-pane-10" role="tabpanel"
                            aria-labelledby="technology-tab-10" tabindex="0">
                            <div class="row g-4 text-center">
                                <div class="col-12 text-start">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="card layout-card">
                                        <div class="card-body">
                                            <a href="/dashboard/dashboard" target="_blank">
                                                <img src="{{ URL::asset('build/images/landing/preview-figma.jpg') }}"
                                                    alt="img" class="img-fluid border">
                                            </a>
                                        </div>
                                    </div>
                                    <a href="/demo/layout-vertical" target="_blank"
                                        class="h5 d-flex align-items-center justify-content-center gap-2">Live Preview
                                        <i class="ti ti-link text-primary f-22"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card layout-card">
                        <div class="card-body">
                            <a href="/application/social-media" target="_blank">
                                <img src="{{ URL::asset('build/images/landing/preview-app-social.jpg') }}"
                                    alt="img" class="img-fluid border">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="card layout-card">
                        <div class="card-body">
                            <a href="/application/gallery-grid" target="_blank">
                                <img src="{{ URL::asset('build/images/landing/preview-app-gallery.jpg') }}"
                                    alt="img" class="img-fluid border">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="card layout-card">
                        <div class="card-body">
                            <a href="/pages/login-v1" target="_blank">
                                <img src="{{ URL::asset('build/images/landing/preview-important-auth-page.jpg') }}"
                                    alt="img" class="img-fluid border">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="card layout-card">
                        <div class="card-body">
                            <a href="/widget/w_statistics" target="_blank">
                                <img src="{{ URL::asset('build/images/landing/preview-important-widgets.jpg') }}"
                                    alt="img" class="img-fluid border">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="card layout-card">
                        <div class="card-body">
                            <a href="/forms/form2_wizard" target="_blank">
                                <img src="{{ URL::asset('build/images/landing/preview-important-wizard.jpg') }}"
                                    alt="img" class="img-fluid border">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="card layout-card">
                        <div class="card-body">
                            <a href="/application/account-profile" target="_blank">
                                <img src="{{ URL::asset('build/images/landing/preview-important-account-profile.jpg') }}"
                                    alt="img" class="img-fluid border">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="card layout-card">
                        <div class="card-body">
                            <a href="/table/dt_advance" target="_blank">
                                <img src="{{ URL::asset('build/images/landing/preview-important-data-table.jpg') }}"
                                    alt="img" class="img-fluid border">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="card layout-card">
                        <div class="card-body">
                            <a href="/forms/form_elements" target="_blank">
                                <img src="{{ URL::asset('build/images/landing/preview-important-form.jpg') }}"
                                    alt="img" class="img-fluid border">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="card layout-card">
                        <div class="card-body">
                            <a href="/pages/error-404" target="_blank">
                                <img src="{{ URL::asset('build/images/landing/preview-important-error.jpg') }}"
                                    alt="img" class="img-fluid border">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="card layout-card">
                        <div class="card-body">
                            <a href="/pages/coming-soon" target="_blank">
                                <img src="{{ URL::asset('build/images/landing/preview-important-coming-soon.jpg') }}"
                                    alt="img" class="img-fluid border">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="card layout-card">
                        <div class="card-body">
                            <a href="/pages/contact-us" target="_blank">
                                <img src="{{ URL::asset('build/images/landing/preview-important-contact.jpg') }}"
                                    alt="img" class="img-fluid border">
                            </a>
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row g-4 text-center ">
                <div class="col-lg-4 col-md-6 wow animate__fadeInUp" data-wow-delay="0.2s">
                    <div class="card layout-card">
                        <div class="card-body">
                            <img src="{{ URL::asset('build/images/landing/preview-page-dark.jpg') }}" alt="img"
                                class="img-fluid border">
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 wow animate__fadeInUp" data-wow-delay="0.4s">
                    <div class="card layout-card">
                        <div class="card-body">
                            <img src="{{ URL::asset('build/images/landing/preview-page-rtl.jpg') }}" alt="img"
                                class="img-fluid border">
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 wow animate__fadeInUp" data-wow-delay="0.6s">
                    <div class="card layout-card">
                        <div class="card-body">
                            <img src="{{ URL::asset('build/images/landing/preview-page-landing.jpg') }}"
                                alt="img" class="img-fluid border">
                        </div>
                    </div>
    ...
    <section class="bg-dark comminuties-section">
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-md-8 col-xl-6">
                    <h2 class="text-white wow animate__fadeInUp section-title" data-wow-delay="0.2s">Testimonials
                    </h2>
                            ...
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <p class="mb-0">"Error Prohibited!!" Yes, we prioritize your project by
                                        conducting thorough design and
                            ...
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <p class="mb-0">Rest assured, our package stays current with the latest plug-ins
                                        and technologies.
                                        You'll receive email notifications for updates, along with detailed changelogs
                                        and version history
                                        on our item page. </p>
                                </div>
                            </div>
                ...
                <div class="col-md-12">
                    <div class="row justify-content-center client-block g-lg-4 g-3">
                        <div class="col-auto wow animate__fadeInRight" data-wow-delay="0.3s"><img
                                src="{{ URL::asset('build/images/landing/client-eagames.svg') }}" alt="img"
                                class="img-fluid"></div>
                        <div class="col-auto wow animate__fadeInRight" data-wow-delay="0.4s"><img
                                src="{{ URL::asset('build/images/landing/client-haswent-2.svg') }}" alt="img"
                                class="img-fluid"></div>
                        <div class="col-auto wow animate__fadeInRight" data-wow-delay="0.5s"><img
                                src="{{ URL::asset('build/images/landing/client-crystal-1.svg') }}" alt="img"
                                class="img-fluid"></div>
                        <div class="col-auto wow animate__fadeInRight" data-wow-delay="0.6s"><img
                                src="{{ URL::asset('build/images/landing/client-vodafone.svg') }}" alt="img"
                                class="img-fluid"></div>
                    ...
                    <div class="col-md-8">
                        <div class="row gy-4">
                            ...
                            <div class="col-sm-4 wow animate__fadeInUp" data-wow-delay="0.8s">
                                ...
                                <ul class="list-unstyled footer-link mb-0">
                                    <li>
                                        <a href="https://pcoded.gitbook.io/light-able"
