                        ...
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="{{ URL::asset('build/images/user/avatar-10.jpg') }}" alt="user-image"
                                    class="user-avtar rounded-circle wid-40 hie-40" />
                            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <h6 class="mb-0 d-flex align-items-center gap-2"><i
                                class="fas fa-circle text-primary text-opacity-25 f-12"></i> Draft</h6>
                ...
                <ul class="list-group list-group-flush border-top-0">
                    <li class="list-group-item border-0">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 mx-2">
                                <h6 class="mb-1">Johnny sent you an invoice billed <a href="#!"
                                        class="link-primary">$1,000</a>.</h6>
                    ...
                    <li class="list-group-item border-0">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 mx-2">
                                <h6 class="mb-1">Sent an invoice to Aida Bugg amount of <a href="#!"
                                        class="link-primary">$200</a>.</h6>
...
@section('scripts')
    ...
    <script src="{{ URL::asset('build/js/widgets/invoice.js') }}"></script>
@endsection
