...
@section('breadcrumb-item-active', 'Setting Payment')
              ...
              <div class="row justify-content-center">
                <div class="col-md-10 col-lg-8 col-xxl-6">
                  <div class="card border text-center">
                    <div class="card-body">
                      <img src="{{ URL::asset('build/images/admin/img-payment-1.png') }}" alt="images" class="img-fluid mb-4" />
            ...
            <div class="tab-pane" id="auth-3" role="tabpanel" aria-labelledby="auth-tab-3">
              ...
              <div class="row justify-content-center">
                <div class="col-md-10 col-lg-8 col-xxl-6">
                  <div class="card border text-center">
                    <div class="card-body">
                      <img src="{{ URL::asset('build/images/admin/img-payment-2.png') }}" alt="images" class="img-fluid mb-4" />
