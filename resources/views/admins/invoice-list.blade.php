...
@section('breadcrumb-item-active', 'List Invoice')
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col">
                                                        <h6 class="mb-1"><span class="text-truncate w-100">Mickie
                                                                Melmoth</span> </h6>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row align-items-center">
                                                    <div class="col-auto pe-0">
                                                        <img src="{{ URL::asset('build/images/user/avatar-9.jpg') }}"
                                                            alt="user-image" class="wid-40 hei-40 rounded-circle" />
                                                    </div>
                                                    <div class="col">
                                                        <h6 class="mb-1"><span class="text-truncate w-100">Shelba
                                                                Thews</span> </h6>
                                                        <p class="f-12 mb-0"><a href="#!" class="text-muted"><span
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row align-items-center">
                                                    <div class="col-auto pe-0">
                                                        <img src="{{ URL::asset('build/images/user/avatar-10.jpg') }}"
                                                            alt="user-image" class="wid-40 hei-40 rounded-circle" />
                                                    </div>
                                                    <div class="col">
                                                        <h6 class="mb-1"><span
                                                                class="text-truncate w-100">tass23@gmail.com</span> </h6>
                                                        <p class="f-12 mb-0"><a href="#!" class="text-muted"><span
                                                                    class="text-truncate w-100">Shelba Thews</span></a></p>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row align-items-center">
                                                    <div class="col-auto pe-0">
                                                        <img src="{{ URL::asset('build/images/user/avatar-8.jpg') }}"
                                                            alt="user-image" class="wid-40 hei-40 rounded-circle" />
                                                    </div>
                                                    <div class="col">
                                                        <h6 class="mb-1"><span
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <p class="f-12 mb-0"><a href="#!"
                                                                class="text-muted"><span
                                                                    class="text-truncate w-100">Shelba Thews</span></a>
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
...
@section('scripts')
    ...
    <script src="{{ URL::asset('build/js/admin/invoice-list.js') }}"></script>
