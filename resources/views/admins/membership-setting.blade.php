                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="password" class="form-control"
                                                            placeholder="Enter Current Password" value="emailis" />
                                                    </div>
                                                </div>
                                            </div>
                                            <p>Can’t Remember your current password?
                                                <a href="#" class="link-primary text-decoration-underline">Reset your
                                                    password</a>
                                            </p>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="card shadow-none border mb-0">
                                <div class="card-body">
                                    ...
                                    <a href="#" class="link-primary d-flex align-items-center gap-2">See more Plan <i
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="card shadow-none border mb-0">
                                <div class="card-body">
                                    ...
                                    <a href="#" class="link-primary d-flex align-items-center gap-2">Update, Cancel
                                        and more <i class="ti ti-chevron-right"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12 col-xl-4">
                            <div class="card shadow-none border mb-0">
                                <div class="card-body">
                                    ...
                                    <a href="#" class="link-primary d-flex align-items-center gap-2">View payment
                                        method <i class="ti ti-chevron-right"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="card shadow-none border mb-0">
                                <div class="card-body">
                                    ...
                                    <p class="mb-3">Would you like to delete your account? <br />
