                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="rounded border p-3 mb-2">
                                <span class="d-block"><i class="fas fa-circle text-primary f-10 m-r-10"></i>New
                                    Membership</span>
                            </div>
                            <div class="rounded border p-3">
                                <span class="d-block"><i
                                        class="fas fa-circle text-primary text-opacity-25 f-10 m-r-10"></i>Repeat
                                    Membership</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item px-0 py-2">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="{{ URL::asset('build/images/user/avatar-3.jpg') }}" alt="img"
                                        class="wid-40 rounded-circle" />
                                </div>
                                <div class="flex-grow-1 mx-3">
                        ...
                        <li class="list-group-item px-0 py-2">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="{{ URL::asset('build/images/user/avatar-4.jpg') }}" alt="img"
                                        class="wid-40 rounded-circle" />
                                </div>
                                <div class="flex-grow-1 mx-3">
                        ...
                        <li class="list-group-item px-0 py-2">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="{{ URL::asset('build/images/user/avatar-5.jpg') }}" alt="img"
                                        class="wid-40 rounded-circle" />
                                </div>
                                <div class="flex-grow-1 mx-3">
                                    <h6 class="mb-1">Airi canceled in 2 months membership</h6>
                        ...
                        <li class="list-group-item px-0 py-2">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="{{ URL::asset('build/images/user/avatar-6.jpg') }}" alt="img"
                                        class="wid-40 rounded-circle" />
                                </div>
                                <div class="flex-grow-1 mx-3">
                                    <h6 class="mb-1">Colleen join Addicted membership</h6>
...
@section('scripts')
    ...
    <script src="{{ URL::asset('build/js/admin/membership-dashboard.js') }}"></script>
