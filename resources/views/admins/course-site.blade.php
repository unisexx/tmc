                        ...
                        <div class="tab-content">
                            <div class="tab-pane show active" id="contactDetail">
                                ...
                                <p class="text-muted mb-4">Incorporate a custom logo and favicon, and fine-tune your school
                                    thumbnail to enhance its appearance and
                                    branding</p>
                                <div class="row g-3">
                                ...
                                <div class="d-flex align-items-center mb-4">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <p class="mb-0 text-muted">Personalize your school and eliminate Able Pro branding
                                            from your school website, emails, and products. To
                                ...
                                <div class="card border">
                                    <div class="card-body">
                                        ...
                                        <p class="mb-0 text-muted">Make your school your own and remove Teachable branding
                                            from your school website, emails, and all
                                            products. Upgrade to the Professional plan to use this feature.</p>
                                    </div>
                                </div>

                                <h5>Color Palette</h5>
                                <p class="text-muted mb-4">Select a predefined color scheme to establish consistency across
                                    your site and products. Alternatively, customize
                                    your own color palette to reflect your unique branding and preferences.</p>
                                <div class="card border">
                                    <div class="card-body">
                                        <div class="row g-4 mb-4">
                                            <div class="col-md-6 col-xl-3">
                                                <div class="admin-color-block">
                                            ...
                                            <div class="col-md-6 col-xl-3">
                                                <div class="admin-color-block active">
                                    ...
                                    <div class="col-md-10 col-lg-8 col-xxl-6">
                                        <div class="card border text-center">
                                            <div class="card-body">
                                                ...
                                                <p class="text-muted">If you edit this domain, your school URL will update
                                                    the next time you log out.</p>
                                                <img src="{{ URL::asset('build/images/admin/img-domain.png') }}" alt="images"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="d-flex flex-column gap-3 align-items-center mb-4">
                                                    <img src="{{ URL::asset('build/images/admin/img-add-user.png') }}" alt="img"
                                                        class="img-fluid" />
                                                    <button class="btn btn-sm btn-outline-secondary">Add Image</button>
                                                </div>
                                                <div id="pc-quil-1" style="height: 125px"></div>
                                                <div class="mt-3 text-center">
                                                    <button data-bs-dismiss="modal" class="btn btn-primary">Add
                                                        Bio</button>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <table class="table table-hover mb-0" id="pc-dt-simple">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>2023/09/12 <span class="text-muted text-sm d-block">09:05
                                                                PM</span></td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>2023/12/24 <span class="text-muted text-sm d-block">09:05
                                                                PM</span></td>
                                                        <td>
                                                            <a href="#" class="avtar avtar-xs btn-link-secondary">
                                                                <i class="ti ti-eye f-20"></i>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>2022/09/19 <span class="text-muted text-sm d-block">09:05
                                                                PM</span></td>
                                                        <td>
                                                            <a href="#" class="avtar avtar-xs btn-link-secondary">
                                                                <i class="ti ti-eye f-20"></i>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>2022/08/22 <span class="text-muted text-sm d-block">09:05
                                                                PM</span></td>
                                                        <td>
                                                            <a href="#" class="avtar avtar-xs btn-link-secondary">
                                                                <i class="ti ti-eye f-20"></i>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="flex-shrink-0">
                                                                    <img src="{{ URL::asset('build/images/user/avatar-6.jpg') }}"
                                                                        alt="user image" class="img-radius wid-40" />
                                                                </div>
                                                                <div class="flex-grow-1 ms-3">
                                                                    <h6 class="mb-0">Ashton Cox</h6>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="flex-shrink-0">
                                                                    <img src="{{ URL::asset('build/images/user/avatar-7.jpg') }}"
                                                                        alt="user image" class="img-radius wid-40" />
                                                                </div>
                                                                <div class="flex-grow-1 ms-3">
                                                                    <h6 class="mb-0">Bradley Greer</h6>
                                        ...
                                        <ul class="nav nav-tabs profile-tabs" id="myTab" role="tablist">
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link active" id="home-tab" data-bs-toggle="tab"
                                                    ...
                                                    aria-controls="home-tab-pane" aria-selected="true">School
                                                    Pages</button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link" id="profile-tab" data-bs-toggle="tab"
                                                    data-bs-target="#profile-tab-pane" type="button" role="tab"
                                                    aria-controls="profile-tab-pane" aria-selected="false">Product
                                                    Pages</button>
                                            </li>
                                        </ul>
                                    </div>
                                                    ...
                                                    <table class="table table-hover mb-0">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>Main Page</td>
                                                                <td>/main.page</td>
                                                                <td><span class="badge text-bg-success">Published</span>
                                                                </td>
                                                                <td>
                                                                    <a href="#"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>/privacy-policy</td>
                                                                <td><span class="badge text-bg-danger">Unpublished</span>
                                                                </td>
                                                                <td>
                                                                    <a href="#"
                                                                        class="avtar avtar-xs btn-link-secondary">
                            ...
                            <div class="d-sm-flex wizard justify-content-between mt-3">
                                ...
                                <div class="d-sm-flex">
                                    <div class="previous me-2">
                                        <a href="javascript:void(0);" class="btn btn-secondary mt-3 mt-md-0"> Back To
                                            Previous </a>
                                    </div>
                                    <div class="next">
                                        <a href="javascript:void(0);" class="btn btn-secondary mt-3 mt-md-0"> Next Step
                                        </a>
                                    </div>
                                </div>
                                <div class="last">
                                    <a href="javascript:void(0);" class="btn btn-secondary mt-3 mt-md-0"> Finish </a>
                                </div>
                            </div>
                        </div>
                    </div>
