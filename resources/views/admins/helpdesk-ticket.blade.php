...
@section('breadcrumb-item-active', 'Ticket list')
...
@section('css')
    ...
    <link rel="stylesheet" href="{{ URL::asset('build/css/plugins/prism-coy.css') }}">
@endsection
                ...
                <div class="card-body">
                    <nav class="navbar justify-content-between p-0 align-items-center">
                        ...
                        <div class="btn-group btn-group-sm help-filter" role="group" aria-label="button groups sm">
                            <a class="btn btn-light-secondary" onclick='filterchange("sm")'><i
                                    class="feather icon-align-justify m-0"></i></a>
                            <a class="btn btn-light-secondary" onclick='filterchange("md")'><i
                                    class="feather icon-menu m-0"></i></a>
                            <a class="btn btn-light-secondary active" onclick='filterchange("large")'><i
                    ...
                    <div class="row">
                        <div class="col-sm-auto mb-3 mb-sm-0">
                            <div class="d-sm-inline-block d-flex align-items-center">
                                <img class="media-object wid-60 img-radius" src="{{ URL::asset('build/images/user/avatar-1.jpg') }}"
                                    alt="Generic placeholder image " />
                                <div class="ms-3 ms-sm-0">
                                    <ul class="text-sm-center list-unstyled mt-2 mb-0 d-inline-block">
                                        <li class="list-unstyled-item"><a href="#" class="link-secondary">1 Ticket</a>
                                        </li>
                                        <li class="list-unstyled-item"><a href="#" class="link-danger"><i
                                                    class="fas fa-heart"></i> 3</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="popup-trigger">
                                ...
                                <div class="help-sm-hidden">
                                    <ul class="list-unstyled mt-2 mb-0 text-muted">
                                        <li class="d-sm-inline-block d-block mt-1"><img src="{{ URL::asset('build/images/admin/p1.jpg') }}"
                                                alt="" class="wid-20 rounded me-2 img-fluid" />Piaf able</li>
                                        <li class="d-sm-inline-block d-block mt-1"><img
                                                src="{{ URL::asset('build/images/user/avatar-5.jpg') }}" alt=""
                                ...
                                <div class="h5 mt-3"><i class="material-icons-two-tone f-16 me-1">lock</i> Theme
                                    customisation issue</div>
                                <div class="help-md-hidden">
                                    <div class="bg-body mb-3 p-3">
                                        <h6><img src="{{ URL::asset('build/images/user/avatar-5.jpg') }}" alt=""
                                                class="wid-20 avatar me-2 rounded" />Last comment from
                                            <a href="#" class="link-secondary">Robert alia:</a>
                                        </h6>
                                        <p class="mb-0"><b>hello John lui</b>,<br />
                                            you need to create <b>"toolbar-options" div only</b> once in a page&nbsp;in your
                                            code,<br />
                            ...
                            <div class="mt-2">
                                <a href="helpdesk-ticket-details" class="me-2 btn btn-sm btn-light-primary"><i
                        ...
                        <div class="col">
                            <div class="popup-trigger">
                                ...
                                <div class="help-sm-hidden">
                                    <ul class="list-unstyled mt-2 mb-0 text-muted">
                                        <li class="d-sm-inline-block d-block mt-1"><img
                                                src="{{ URL::asset('build/images/admin/p1.jpg') }}" alt=""
                                                class="wid-20 rounded me-2 img-fluid" />Piaf able</li>
                                        <li class="d-sm-inline-block d-block mt-1"><img
                                                src="{{ URL::asset('build/images/user/avatar-5.jpg') }}" alt=""
                                                class="wid-20 rounded me-2 img-fluid" />Assigned to
                                            <b>Robert alia</b>
            ...
            <div class="right-side">
                    ...
                    <ul class="list-group list-group-flush pb-2">
                        <li class="list-group-item">
                            <div class="d-inline-block">
                                <img src="{{ URL::asset('build/images/admin/p1.jpg') }}" alt=""
                                    class="wid-20 rounded me-1 img-fluid" />
                                <a href="#" class="link-secondary">Piaf able</a>
                            </div>
                            <div class="float-end">
                                <a href="#" class="badge bg-light-danger rounded-circle me-1"
                                    data-bs-toggle="tooltip" data-bs-placement="top" title=""
                                    data-original-title="tooltip on top">1</a>
                                <a href="#" class="badge bg-light-secondary rounded-circle me-0"
                                    data-bs-toggle="tooltip" data-bs-placement="top" title=""
                        ...
                        <li class="list-group-item">
                            <div class="d-inline-block">
                                <img src="{{ URL::asset('build/images/admin/p2.jpg') }}" alt=""
                                    class="wid-20 rounded me-1 img-fluid" />
                        ...
                        <li class="list-group-item">
                            <div class="d-inline-block">
                                <img src="{{ URL::asset('build/images/admin/p3.jpg') }}" alt=""
                                    class="wid-20 rounded me-1 img-fluid" />
                        ...
                        <li class="list-group-item">
                            <div class="d-inline-block">
                                <img src="{{ URL::asset('build/images/admin/p4.jpg') }}" alt=""
                                    class="wid-20 rounded me-1 img-fluid" />
                        ...
                        <li class="list-group-item">
                            <div class="d-inline-block">
                                <img src="{{ URL::asset('build/images/admin/p5.jpg') }}" alt=""
                                    class="wid-20 rounded me-1 img-fluid" />
                ...
                <div class="card">
                    ...
                    <ul class="list-group list-group-flush pb-2">
                        <li class="list-group-item">
                            <div class="d-inline-block">
                                <img src="{{ URL::asset('build/images/user/avatar-5.jpg') }}" alt=""
                                    class="wid-20 rounded me-1 img-fluid" />
                        ...
                        <li class="list-group-item">
                            <div class="d-inline-block">
                                <img src="{{ URL::asset('build/images/user/avatar-4.jpg') }}" alt=""
                                    class="wid-20 rounded me-1 img-fluid" />
                        ...
                        <li class="list-group-item">
                            <div class="d-inline-block">
                                <img src="{{ URL::asset('build/images/user/avatar-3.jpg') }}" alt=""
                                    class="wid-20 rounded me-1 img-fluid" />
                        ...
                        <li class="list-group-item">
                            <div class="d-inline-block">
                                <img src="{{ URL::asset('build/images/user/avatar-2.jpg') }}" alt=""
                                    class="wid-20 rounded me-1 img-fluid" />
                        ...
                        <li class="list-group-item">
                            <div class="d-inline-block">
                                <img src="{{ URL::asset('build/images/user/avatar-1.jpg') }}" alt=""
                                    class="wid-20 rounded me-1 img-fluid" />
        ...
        <div class="modal-dialog q-view-modal" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Chrome bug The page uses a roller to slide under a black block<span
                            class="badge bg-light-danger text-uppercase ms-2 f-12">Private</span></h5>
                ...
                <div class="scroll-div position-relative" style="height: calc(100vh - 90px)">
                    <div class="modal-body border-bottom px-4">
                        <div class="row">
                            <div class="col-md-7">
                                <span type="button" class="badge bg-light-success me-1"><i
                                        class="feather icon-check me-1"></i> Closed</span>
                                <p class="list-inline-item mb-0"><img src="{{ URL::asset('build/images/admin/p1.jpg') }}" alt=""
                                        class="wid-20 rounded me-1 img-fluid" />Alpha pro</p>
                            </div>
                            <div class="col-md-5 text-end">
                                <p class="d-inline-block mb-0"><i
                                        class="wid-20 material-icons-two-tone text-center f-16 me-2">calendar_today</i><label
                    ...
                    <div class="modal-body border-bottom px-4">
                        <div class="row">
                            <div class="col-auto">
                                <img class="media-object wid-60 img-radius" src="{{ URL::asset('build/images/user/avatar-5.jpg') }}"
                                    alt="Generic placeholder image " />
                            </div>
                            <div class="col">
                    ...
                    <div class="modal-body border-bottom px-4">
                        <div class="row align-items-center">
                            ...
                            <div class="col">
                                <h6 class="mb-0">Support Agent name<span class="badge bg-light-secondary ms-2">Support
                                        Agent</span></h6>
                                <label class="text-muted">5 Month ago</label>
                            </div>
                            <div class="col-auto">
                                <ul class="list-unstyled mb-0">
                                    <li class="d-inline-block me-1"><a href="#"><i
                                                class="feather icon-edit text-muted"></i></a></li>
                                    <li class="d-inline-block"><a href="#"><i
                                                class="feather icon-trash-2 text-muted"></i></a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="mt-3">
...
@section('scripts')
    <script src="{{ URL::asset('build/js/plugins/prism.js') }}"></script>
    <script src='{{ URL::asset('build/js/plugins/quill.js') }}'></script>

    <script>
        function filterchange(tempnum) {
            var c = document.querySelector(".help-main");
            if (tempnum == "sm") {
                if (c.classList.contains("large-view")) {
                    c.classList.remove("large-view");
                } else if (c.classList.contains("md-view")) {
                    c.classList.remove("md-view");
                }
                c.classList.add("sm-view");
            } else if (tempnum == "md") {
                if (c.classList.contains("large-view")) {
                    c.classList.remove("large-view");
                } else if (c.classList.contains("sm-view")) {
                    c.classList.remove("sm-view");
                }
                c.classList.add("md-view");
            } else if (tempnum == "large") {
                if (c.classList.contains("sm-view")) {
                    c.classList.remove("sm-view");
                } else if (c.classList.contains("md-view")) {
                    c.classList.remove("md-view");
                }
                c.classList.add("large-view");
            }
        }
        // Menu scrollbar end
        (function() {
        ...
        if (!!document.querySelector('.scroll-div')) {
            new SimpleBar(document.querySelector('.scroll-div'));
        }
        var tc = document.querySelectorAll('.help-filter a');
        for (var t = 0; t < tc.length; t++) {
            var c = tc[t];
            c.addEventListener('click', function(event) {
                if (!!document.querySelector('.help-filter a.active')) {
                    document.querySelector('.help-filter a.active').classList.remove("active");
                }
