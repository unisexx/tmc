                ...
                <table class="table table-hover mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td
                        ><input type="text" class="form-control" placeholder="Description" value="Mic Bluetooth 4.2, Rockerz 450R"
                      /></td>
                    ...
                    <span class="row align-items-center justify-content-between">
                      ...
                      <span class="col-6 text-end">
                        <span class="address-btns d-flex align-items-center justify-content-end">
                          <a href="#" class="avtar avtar-s btn-link-danger btn-pc-default mx-1">
