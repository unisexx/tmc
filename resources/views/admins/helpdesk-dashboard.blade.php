...
@section('breadcrumb-item-active', 'Helpdesk Dashboard')
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <span>It takes continuous effort to maintain high customer satisfaction levels.Internal and external
                        quality measures are often
                        tied together.,as the opinion...</span>
                    <a href="#!" class="text-primary d-block">Learn more..</a>
                ...
                <div class="latest-scroll" style="height: 400px; position: relative">
                    <div class="card-body">
                        <div class="row align-items-center m-b-30">
                            ...
                            <div class="col">
                                <a href="#!">
                                    <h6>You have 3 pending tasks. <span class="text-muted float-end f-13">Just Now</span>
                                    </h6>
                                </a>
                            </div>
                        </div>
                        <div class="row align-items-center m-b-30">
                            ...
                            <div class="col">
                                <a href="#!">
                                    <h6>New order received <span class="text-muted float-end f-13">Just Now</span></h6>
                                </a>
                            </div>
                        </div>
                        <div class="row align-items-center m-b-30">
...
@section('scripts')
    ...
    <script src="{{ URL::asset('build/js/widgets/help.js') }}"></script>
