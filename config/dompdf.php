...
return [
    ...
    'options'          => [
        ...
        // ตั้งชื่อฟอนต์ custom ของเรา
        'fonts'                     => [
            'sarabun' => [
                'R'  => public_path('fonts/sarabun/Sarabun-Regular.ttf'),
                'B'  => public_path('fonts/sarabun/Sarabun-Bold.ttf'),
                'I'  => public_path('fonts/sarabun/Sarabun-Italic.ttf'),
                'BI' => public_path('fonts/sarabun/Sarabun-BoldItalic.ttf'),
            ],
            // ถ้าจะเพิ่ม NotoSansThai ก็ทำคล้ายกัน
        ],
    ],
